...
import {EnumValueKinds} from './internal';
...
export class EnumValueInfoImpl implements EnumValueInfo, TypeChecker {
  ...
  public entityKind: EnumValueKinds;
  ...
  protected static _concreteKinds: {[x: number]: EnumValueKinds[]};
  ...
  constructor(dtdlVersion: number, id: string, childOf: string|undefined, definedIn: string|undefined, entityKind: EnumValueKinds) {
