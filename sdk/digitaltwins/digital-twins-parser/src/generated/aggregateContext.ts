...
import {ContextHistory, InDTMI, ParsingError, ParsingException, VersionedContext} from '../parser';
...
export class AggregateContext {
  ...
  static initialize() {
    ...
    AggregateContext._affiliateContextHistories['dtmi:iotcentral:context'] = AggregateContext._getAffiliate0ContextHistory();
    AggregateContext._affiliateContextHistories['dtmi:dtdl:extension:layering'] = AggregateContext._getAffiliate1ContextHistory();
    AggregateContext._affiliateContextHistories['dtmi:dtdl:extension:initialization'] = AggregateContext._getAffiliate2ContextHistory();
    AggregateContext._affiliateContextHistories['dtmi:dtdl:extension:historization'] = AggregateContext._getAffiliate3ContextHistory();
  }
  ...
  static _getDtdlContextHistory(): ContextHistory {
    ...
    context2_0.addDefinition('QuantitativeType', new InDTMI('dtmi:standard:class:QuantitativeType;2'));
    ...
    context2_0.addDefinition('AngularAcceleration', new InDTMI('dtmi:standard:class:AngularAcceleration;2'));
    context2_0.addDefinition('AngularVelocity', new InDTMI('dtmi:standard:class:AngularVelocity;2'));
    ...
    context2_0.addDefinition('LuminousIntensity', new InDTMI('dtmi:standard:class:LuminousIntensity;2'));
    context2_0.addDefinition('MagneticFlux', new InDTMI('dtmi:standard:class:MagneticFlux;2'));
    context2_0.addDefinition('MagneticInduction', new InDTMI('dtmi:standard:class:MagneticInduction;2'));
    ...
    context2_0.addDefinition('RelativeHumidity', new InDTMI('dtmi:standard:class:RelativeHumidity;2'));
    ...
    context2_0.addDefinition('AccelerationUnit', new InDTMI('dtmi:standard:class:AccelerationUnit;2'));
    context2_0.addDefinition('AngleUnit', new InDTMI('dtmi:standard:class:AngleUnit;2'));
    context2_0.addDefinition('AngularAccelerationUnit', new InDTMI('dtmi:standard:class:AngularAccelerationUnit;2'));
    context2_0.addDefinition('AngularVelocityUnit', new InDTMI('dtmi:standard:class:AngularVelocityUnit;2'));
    context2_0.addDefinition('AreaUnit', new InDTMI('dtmi:standard:class:AreaUnit;2'));
    context2_0.addDefinition('CapacitanceUnit', new InDTMI('dtmi:standard:class:CapacitanceUnit;2'));
    ...
    context2_0.addDefinition('IlluminanceUnit', new InDTMI('dtmi:standard:class:IlluminanceUnit;2'));
    ...
    context2_0.addDefinition('LuminousFluxUnit', new InDTMI('dtmi:standard:class:LuminousFluxUnit;2'));
    context2_0.addDefinition('LuminousIntensityUnit', new InDTMI('dtmi:standard:class:LuminousIntensityUnit;2'));
    context2_0.addDefinition('MagneticFluxUnit', new InDTMI('dtmi:standard:class:MagneticFluxUnit;2'));
    context2_0.addDefinition('MagneticInductionUnit', new InDTMI('dtmi:standard:class:MagneticInductionUnit;2'));
    context2_0.addDefinition('MassUnit', new InDTMI('dtmi:standard:class:MassUnit;2'));
    context2_0.addDefinition('MassFlowRateUnit', new InDTMI('dtmi:standard:class:MassFlowRateUnit;2'));
    ...
    context2_0.addDefinition('SoundPressureUnit', new InDTMI('dtmi:standard:class:SoundPressureUnit;2'));
    context2_0.addDefinition('TemperatureUnit', new InDTMI('dtmi:standard:class:TemperatureUnit;2'));
    ...
    context2_0.addDefinition('VolumeFlowRateUnit', new InDTMI('dtmi:standard:class:VolumeFlowRateUnit;2'));
    ...
    context2_0.addDefinition('asynchronous', new InDTMI('dtmi:dtdl:instance:CommandType:asynchronous;2'));
    context2_0.addDefinition('synchronous', new InDTMI('dtmi:dtdl:instance:CommandType:synchronous;2'));
    ...
    context2_0.addDefinition('metrePerSecondSquared', new InDTMI('dtmi:standard:unit:metrePerSecondSquared;2'));
    context2_0.addDefinition('centimetrePerSecondSquared', new InDTMI('dtmi:standard:unit:centimetrePerSecondSquared;2'));
    ...
    context2_0.addDefinition('radianPerSecondSquared', new InDTMI('dtmi:standard:unit:radianPerSecondSquared;2'));
    ...
    context2_0.addDefinition('revolutionPerSecond', new InDTMI('dtmi:standard:unit:revolutionPerSecond;2'));
    context2_0.addDefinition('revolutionPerMinute', new InDTMI('dtmi:standard:unit:revolutionPerMinute;2'));
    context2_0.addDefinition('squareMetre', new InDTMI('dtmi:standard:unit:squareMetre;2'));
    context2_0.addDefinition('squareCentimetre', new InDTMI('dtmi:standard:unit:squareCentimetre;2'));
    context2_0.addDefinition('squareMillimetre', new InDTMI('dtmi:standard:unit:squareMillimetre;2'));
    ...
    context2_0.addDefinition('kibibitPerSecond', new InDTMI('dtmi:standard:unit:kibibitPerSecond;2'));
    context2_0.addDefinition('mebibitPerSecond', new InDTMI('dtmi:standard:unit:mebibitPerSecond;2'));
    context2_0.addDefinition('gibibitPerSecond', new InDTMI('dtmi:standard:unit:gibibitPerSecond;2'));
    context2_0.addDefinition('tebibitPerSecond', new InDTMI('dtmi:standard:unit:tebibitPerSecond;2'));
    context2_0.addDefinition('exbibitPerSecond', new InDTMI('dtmi:standard:unit:exbibitPerSecond;2'));
    context2_0.addDefinition('zebibitPerSecond', new InDTMI('dtmi:standard:unit:zebibitPerSecond;2'));
    context2_0.addDefinition('yobibitPerSecond', new InDTMI('dtmi:standard:unit:yobibitPerSecond;2'));
    context2_0.addDefinition('bytePerSecond', new InDTMI('dtmi:standard:unit:bytePerSecond;2'));
    context2_0.addDefinition('kibibytePerSecond', new InDTMI('dtmi:standard:unit:kibibytePerSecond;2'));
    context2_0.addDefinition('mebibytePerSecond', new InDTMI('dtmi:standard:unit:mebibytePerSecond;2'));
    context2_0.addDefinition('gibibytePerSecond', new InDTMI('dtmi:standard:unit:gibibytePerSecond;2'));
    context2_0.addDefinition('tebibytePerSecond', new InDTMI('dtmi:standard:unit:tebibytePerSecond;2'));
    context2_0.addDefinition('exbibytePerSecond', new InDTMI('dtmi:standard:unit:exbibytePerSecond;2'));
    context2_0.addDefinition('zebibytePerSecond', new InDTMI('dtmi:standard:unit:zebibytePerSecond;2'));
    context2_0.addDefinition('yobibytePerSecond', new InDTMI('dtmi:standard:unit:yobibytePerSecond;2'));
    ...
    context2_0.addDefinition('kilogramPerCubicMetre', new InDTMI('dtmi:standard:unit:kilogramPerCubicMetre;2'));
    context2_0.addDefinition('gramPerCubicMetre', new InDTMI('dtmi:standard:unit:gramPerCubicMetre;2'));
    ...
    context2_0.addDefinition('megaelectronvolt', new InDTMI('dtmi:standard:unit:megaelectronvolt;2'));
    ...
    context2_0.addDefinition('astronomicalUnit', new InDTMI('dtmi:standard:unit:astronomicalUnit;2'));
    context2_0.addDefinition('candelaPerSquareMetre', new InDTMI('dtmi:standard:unit:candelaPerSquareMetre;2'));
    ...
    context2_0.addDefinition('kilogramPerSecond', new InDTMI('dtmi:standard:unit:kilogramPerSecond;2'));
    ...
    context2_0.addDefinition('kilowattHourPerYear', new InDTMI('dtmi:standard:unit:kilowattHourPerYear;2'));
    ...
    context2_0.addDefinition('millimetresOfMercury', new InDTMI('dtmi:standard:unit:millimetresOfMercury;2'));
    context2_0.addDefinition('poundPerSquareInch', new InDTMI('dtmi:standard:unit:poundPerSquareInch;2'));
    ...
    context2_0.addDefinition('degreeFahrenheit', new InDTMI('dtmi:standard:unit:degreeFahrenheit;2'));
    ...
    context2_0.addDefinition('centimetrePerSecond', new InDTMI('dtmi:standard:unit:centimetrePerSecond;2'));
    context2_0.addDefinition('kilometrePerSecond', new InDTMI('dtmi:standard:unit:kilometrePerSecond;2'));
    context2_0.addDefinition('metrePerHour', new InDTMI('dtmi:standard:unit:metrePerHour;2'));
    context2_0.addDefinition('kilometrePerHour', new InDTMI('dtmi:standard:unit:kilometrePerHour;2'));
    ...
    context2_0.addDefinition('millilitrePerSecond', new InDTMI('dtmi:standard:unit:millilitrePerSecond;2'));
    context2_0.addDefinition('litrePerHour', new InDTMI('dtmi:standard:unit:litrePerHour;2'));
    context2_0.addDefinition('millilitrePerHour', new InDTMI('dtmi:standard:unit:millilitrePerHour;2'));
    context2_0.addDefinition('point', new InDTMI('dtmi:standard:schema:geospatial:point;2'));
    context2_0.addDefinition('multiPoint', new InDTMI('dtmi:standard:schema:geospatial:multiPoint;2'));
    context2_0.addDefinition('lineString', new InDTMI('dtmi:standard:schema:geospatial:lineString;2'));
    context2_0.addDefinition('multiLineString', new InDTMI('dtmi:standard:schema:geospatial:multiLineString;2'));
    context2_0.addDefinition('polygon', new InDTMI('dtmi:standard:schema:geospatial:polygon;2'));
    context2_0.addDefinition('multiPolygon', new InDTMI('dtmi:standard:schema:geospatial:multiPolygon;2'));
    ...
    context3_0.addDefinition('QuantitativeType', new InDTMI('dtmi:standard:class:QuantitativeType;3'));
    ...
    context3_0.addDefinition('AngularAcceleration', new InDTMI('dtmi:standard:class:AngularAcceleration;3'));
    context3_0.addDefinition('AngularVelocity', new InDTMI('dtmi:standard:class:AngularVelocity;3'));
    ...
    context3_0.addDefinition('LuminousIntensity', new InDTMI('dtmi:standard:class:LuminousIntensity;3'));
    context3_0.addDefinition('MagneticFlux', new InDTMI('dtmi:standard:class:MagneticFlux;3'));
    context3_0.addDefinition('MagneticInduction', new InDTMI('dtmi:standard:class:MagneticInduction;3'));
    ...
    context3_0.addDefinition('RelativeHumidity', new InDTMI('dtmi:standard:class:RelativeHumidity;3'));
    ...
    context3_0.addDefinition('AccelerationUnit', new InDTMI('dtmi:standard:class:AccelerationUnit;3'));
    context3_0.addDefinition('AngleUnit', new InDTMI('dtmi:standard:class:AngleUnit;3'));
    context3_0.addDefinition('AngularAccelerationUnit', new InDTMI('dtmi:standard:class:AngularAccelerationUnit;3'));
    context3_0.addDefinition('AngularVelocityUnit', new InDTMI('dtmi:standard:class:AngularVelocityUnit;3'));
    context3_0.addDefinition('AreaUnit', new InDTMI('dtmi:standard:class:AreaUnit;3'));
    context3_0.addDefinition('CapacitanceUnit', new InDTMI('dtmi:standard:class:CapacitanceUnit;3'));
    ...
    context3_0.addDefinition('IlluminanceUnit', new InDTMI('dtmi:standard:class:IlluminanceUnit;3'));
    ...
    context3_0.addDefinition('LuminousFluxUnit', new InDTMI('dtmi:standard:class:LuminousFluxUnit;3'));
    context3_0.addDefinition('LuminousIntensityUnit', new InDTMI('dtmi:standard:class:LuminousIntensityUnit;3'));
    context3_0.addDefinition('MagneticFluxUnit', new InDTMI('dtmi:standard:class:MagneticFluxUnit;3'));
    context3_0.addDefinition('MagneticInductionUnit', new InDTMI('dtmi:standard:class:MagneticInductionUnit;3'));
    context3_0.addDefinition('MassUnit', new InDTMI('dtmi:standard:class:MassUnit;3'));
    context3_0.addDefinition('MassFlowRateUnit', new InDTMI('dtmi:standard:class:MassFlowRateUnit;3'));
    ...
    context3_0.addDefinition('SoundPressureUnit', new InDTMI('dtmi:standard:class:SoundPressureUnit;3'));
    context3_0.addDefinition('TemperatureUnit', new InDTMI('dtmi:standard:class:TemperatureUnit;3'));
    ...
    context3_0.addDefinition('VolumeFlowRateUnit', new InDTMI('dtmi:standard:class:VolumeFlowRateUnit;3'));
    ...
    context3_0.addDefinition('asynchronous', new InDTMI('dtmi:dtdl:instance:CommandType:asynchronous;3'));
    context3_0.addDefinition('synchronous', new InDTMI('dtmi:dtdl:instance:CommandType:synchronous;3'));
    ...
    context3_0.addDefinition('metrePerSecondSquared', new InDTMI('dtmi:standard:unit:metrePerSecondSquared;3'));
    context3_0.addDefinition('centimetrePerSecondSquared', new InDTMI('dtmi:standard:unit:centimetrePerSecondSquared;3'));
    ...
    context3_0.addDefinition('radianPerSecondSquared', new InDTMI('dtmi:standard:unit:radianPerSecondSquared;3'));
    ...
    context3_0.addDefinition('revolutionPerSecond', new InDTMI('dtmi:standard:unit:revolutionPerSecond;3'));
    context3_0.addDefinition('revolutionPerMinute', new InDTMI('dtmi:standard:unit:revolutionPerMinute;3'));
    context3_0.addDefinition('squareMetre', new InDTMI('dtmi:standard:unit:squareMetre;3'));
    context3_0.addDefinition('squareCentimetre', new InDTMI('dtmi:standard:unit:squareCentimetre;3'));
    context3_0.addDefinition('squareMillimetre', new InDTMI('dtmi:standard:unit:squareMillimetre;3'));
    ...
    context3_0.addDefinition('kibibitPerSecond', new InDTMI('dtmi:standard:unit:kibibitPerSecond;3'));
    context3_0.addDefinition('mebibitPerSecond', new InDTMI('dtmi:standard:unit:mebibitPerSecond;3'));
    context3_0.addDefinition('gibibitPerSecond', new InDTMI('dtmi:standard:unit:gibibitPerSecond;3'));
    context3_0.addDefinition('tebibitPerSecond', new InDTMI('dtmi:standard:unit:tebibitPerSecond;3'));
    context3_0.addDefinition('exbibitPerSecond', new InDTMI('dtmi:standard:unit:exbibitPerSecond;3'));
    context3_0.addDefinition('zebibitPerSecond', new InDTMI('dtmi:standard:unit:zebibitPerSecond;3'));
    context3_0.addDefinition('yobibitPerSecond', new InDTMI('dtmi:standard:unit:yobibitPerSecond;3'));
    context3_0.addDefinition('bytePerSecond', new InDTMI('dtmi:standard:unit:bytePerSecond;3'));
    context3_0.addDefinition('kibibytePerSecond', new InDTMI('dtmi:standard:unit:kibibytePerSecond;3'));
    context3_0.addDefinition('mebibytePerSecond', new InDTMI('dtmi:standard:unit:mebibytePerSecond;3'));
    context3_0.addDefinition('gibibytePerSecond', new InDTMI('dtmi:standard:unit:gibibytePerSecond;3'));
    context3_0.addDefinition('tebibytePerSecond', new InDTMI('dtmi:standard:unit:tebibytePerSecond;3'));
    context3_0.addDefinition('exbibytePerSecond', new InDTMI('dtmi:standard:unit:exbibytePerSecond;3'));
    context3_0.addDefinition('zebibytePerSecond', new InDTMI('dtmi:standard:unit:zebibytePerSecond;3'));
    context3_0.addDefinition('yobibytePerSecond', new InDTMI('dtmi:standard:unit:yobibytePerSecond;3'));
    ...
    context3_0.addDefinition('kilogramPerCubicMetre', new InDTMI('dtmi:standard:unit:kilogramPerCubicMetre;3'));
    context3_0.addDefinition('gramPerCubicMetre', new InDTMI('dtmi:standard:unit:gramPerCubicMetre;3'));
    ...
    context3_0.addDefinition('megaelectronvolt', new InDTMI('dtmi:standard:unit:megaelectronvolt;3'));
    ...
    context3_0.addDefinition('astronomicalUnit', new InDTMI('dtmi:standard:unit:astronomicalUnit;3'));
    context3_0.addDefinition('candelaPerSquareMetre', new InDTMI('dtmi:standard:unit:candelaPerSquareMetre;3'));
    ...
    context3_0.addDefinition('kilogramPerSecond', new InDTMI('dtmi:standard:unit:kilogramPerSecond;3'));
    ...
    context3_0.addDefinition('kilowattHourPerYear', new InDTMI('dtmi:standard:unit:kilowattHourPerYear;3'));
    ...
    context3_0.addDefinition('millimetresOfMercury', new InDTMI('dtmi:standard:unit:millimetresOfMercury;3'));
    context3_0.addDefinition('poundPerSquareInch', new InDTMI('dtmi:standard:unit:poundPerSquareInch;3'));
    ...
    context3_0.addDefinition('degreeFahrenheit', new InDTMI('dtmi:standard:unit:degreeFahrenheit;3'));
    ...
    context3_0.addDefinition('centimetrePerSecond', new InDTMI('dtmi:standard:unit:centimetrePerSecond;3'));
    context3_0.addDefinition('kilometrePerSecond', new InDTMI('dtmi:standard:unit:kilometrePerSecond;3'));
    context3_0.addDefinition('metrePerHour', new InDTMI('dtmi:standard:unit:metrePerHour;3'));
    context3_0.addDefinition('kilometrePerHour', new InDTMI('dtmi:standard:unit:kilometrePerHour;3'));
    ...
    context3_0.addDefinition('millilitrePerSecond', new InDTMI('dtmi:standard:unit:millilitrePerSecond;3'));
    context3_0.addDefinition('litrePerHour', new InDTMI('dtmi:standard:unit:litrePerHour;3'));
    context3_0.addDefinition('millilitrePerHour', new InDTMI('dtmi:standard:unit:millilitrePerHour;3'));
    context3_0.addDefinition('point', new InDTMI('dtmi:standard:schema:geospatial:point;3'));
    context3_0.addDefinition('multiPoint', new InDTMI('dtmi:standard:schema:geospatial:multiPoint;3'));
    context3_0.addDefinition('lineString', new InDTMI('dtmi:standard:schema:geospatial:lineString;3'));
    context3_0.addDefinition('multiLineString', new InDTMI('dtmi:standard:schema:geospatial:multiLineString;3'));
    context3_0.addDefinition('polygon', new InDTMI('dtmi:standard:schema:geospatial:polygon;3'));
    context3_0.addDefinition('multiPolygon', new InDTMI('dtmi:standard:schema:geospatial:multiPolygon;3'));
  ...
  static _getAffiliate0ContextHistory(): ContextHistory {
    ...
    context2_0.addDefinition('VelocityVector', new InDTMI('dtmi:iotcentral:class:VelocityVector;2'));
    context2_0.addDefinition('AccelerationVector', new InDTMI('dtmi:iotcentral:class:AccelerationVector;2'));
    ...
    context3_0.addDefinition('VelocityVector', new InDTMI('dtmi:iotcentral:class:VelocityVector;3'));
    context3_0.addDefinition('AccelerationVector', new InDTMI('dtmi:iotcentral:class:AccelerationVector;3'));
  ...
  static _getAffiliate2ContextHistory(): ContextHistory {
    const versionedContexts: VersionedContext[] = [];
    const context1_0 = new VersionedContext(1, 0);
    context1_0.addDefinition('Initialized', new InDTMI('dtmi:dtdl:extension:initialization:v1:Initialized'));
    context1_0.addDefinition('initialValue', new InDTMI('dtmi:dtdl:extension:initialization:v1:Initialized:initialValue'));
    versionedContexts.push(context1_0);
    return new ContextHistory(versionedContexts);
  }
  ...
  static _getAffiliate3ContextHistory(): ContextHistory {
    const versionedContexts: VersionedContext[] = [];
    const context1_0 = new VersionedContext(1, 0);
    context1_0.addDefinition('Historized', new InDTMI('dtmi:dtdl:extension:historization:v1:Historized'));
    versionedContexts.push(context1_0);
    const context2_0 = new VersionedContext(2, 0);
    context2_0.addDefinition('Historized', new InDTMI('dtmi:dtdl:extension:historization:v2:Historized'));
    versionedContexts.push(context2_0);
    return new ContextHistory(versionedContexts);
  }
  ...
  public static getTermOrUri(uriString: string): string {
    ...
    for (const affiliateName in AggregateContext._affiliateContextHistories) { // eslint-disable-line guard-for-in
  ...
  public getChildContext(obj: {[index: string]: any}, parsingErrors: ParsingError[]): AggregateContext {
    if (!Object.prototype.hasOwnProperty.call(obj, AggregateContext._contextKeyword)) {
      if (this._activeDtdlContext === undefined) {
        parsingErrors.push(new ParsingError(
    ...
    if (Array.isArray(contextToken)) {
      ...
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:invalidContext',
        {
  ...
  public createDtmi(uriOrTerm: string): InDTMI | undefined {
    ...
    for (const affiliateName in this._activeAffiliateContexts) { // eslint-disable-line guard-for-in
  ...
  private _getChildContextFromContextArray(contextArray: any[], parsingErrors: ParsingError[]): AggregateContext {
    ...
    while (startIndex < contextArray.length && typeof contextArray[startIndex] === 'string' && Object.prototype.hasOwnProperty.call(AggregateContext._affiliateContextsImplicitDtdlVersions, contextArray[startIndex])) {
    ...
    while (startIndex < contextArray.length && typeof contextArray[startIndex] === 'string' && contextArray[startIndex].startsWith(AggregateContext._dtdlContextPrefix)) {
    ...
    if (startIndex <= endIndex || prefaceAffiliateContexts !== {}) {
      ...
      for (const affiliateName in prefaceAffiliateContexts) { // eslint-disable-line guard-for-in
  ...
  private _getDtdlContextFromContextString(contextString: string, parsingErrors: ParsingError[]): VersionedContext {
    const dtdlContextDtmi = InDTMI.createDtmi(contextString);
    if (dtdlContextDtmi === undefined || dtdlContextDtmi.fragment != '') {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:invalidContextSpecifier',
        {
    ...
    if (dtdlContextDtmi.majorVersion == 0) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:missingContextVersion',
        {
    ...
    if (versionedContext === undefined) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:unrecognizedContextVersion',
        {
    ...
    if (!IdValidator.isIdReferenceValid(contextString, dtdlContextDtmi.majorVersion)) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:invalidContextSpecifierForVersion',
        {
  ...
  private _getAffiliateContextFromContextToken(contextToken: any, dtdlVersion: number, parsingErrors: ParsingError[]): {name: string, context: VersionedContext} | undefined {
    if (typeof contextToken !== 'string') {
      if (typeof contextToken === 'object') {
        parsingErrors.push(new ParsingError(
          'dtmi:dtdl:parsingError:localContextNotLast',
          {
    ...
    if (contextToken.startsWith(AggregateContext._dtdlContextPrefix)) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:dtdlContextFollowsAffiliate',
        {
    ...
    if (!contextToken.startsWith(`dtmi:`)) {
      if (this._rejectNonDtmiContexts) {
        parsingErrors.push(new ParsingError(
          'dtmi:dtdl:parsingError:nonDtmiContextSpecifier',
          {
    ...
    if (!Object.prototype.hasOwnProperty.call(AggregateContext._affiliateContextHistories, affiliateContextDtmi.versionless)) {
      if (this._rejectUndefinedExtensions) {
        parsingErrors.push(new ParsingError(
          'dtmi:dtdl:parsingError:unresolvableContextSpecifier',
          {
    ...
    if (affiliateContext === undefined) {
      if (this._rejectUndefinedExtensions) {
        parsingErrors.push(new ParsingError(
          'dtmi:dtdl:parsingError:unresolvableContextVersion',
          {
  ...
  private _getChildDefinitionsfromContextObject(contextObj: {[term: string]: string}, dtdlVersion: number, parsingErrors: ParsingError[]): {childTermDefinitions: TermDict, childPrefixDefinitions: PrefixDict} {
    const termDefinitions = {...this._localTermDefinitions};
    const prefixDefinitions = {...this._localPrefixDefinitions};

    for (const term in contextObj) { // eslint-disable-line guard-for-in
      if (term == '') {
        parsingErrors.push(new ParsingError(
      ...
      if (AggregateContext._dtdlContextHistory.isTermInContext(term)) {
        parsingErrors.push(new ParsingError(
          'dtmi:dtdl:parsingError:localTermReserved',
          {
