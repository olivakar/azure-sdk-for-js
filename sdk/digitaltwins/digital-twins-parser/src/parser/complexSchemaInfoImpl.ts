...
export abstract class ComplexSchemaInfoImpl implements ComplexSchemaInfo, TypeChecker {
  ...
  constructor(dtdlVersion: number, id: string, childOf: string|undefined, definedIn: string|undefined, entityKind: ComplexSchemaKinds) {
