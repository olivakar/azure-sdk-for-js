...
export abstract class NumericSchemaInfoImpl implements NumericSchemaInfo, TypeChecker {
  ...
  static parseObject(
    ...
    switch (childAggregateContext.dtdlVersion) {
      case 2: {
        (elementInfo as NumericSchemaInfoImpl)?.parsePropertiesV2(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
      ...
      case 3: {
        (elementInfo as NumericSchemaInfoImpl)?.parsePropertiesV3(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
    ...
    for (const supplementalTypeId of supplementalTypeIds) {
      ...
      if (elementInfo.ref !== undefined && elementInfo.ref.entityKind !== undefined) {
        if (
          ...
          (elementInfo.ref as NumericSchemaInfoImpl).addType(
            supplementalTypeId,
  ...
  static tryParseTypeStringV2(
    ...
    elementInfo: Reference<NumericSchemaInfo>,
