...
import {ParsedObjectPropertyInfo, ParsingError} from '../parser/internal';
// codegen-outline-end
...
export class Model {
  ...
  trySetObjectProperty(elementId: string, propertyName: string, referencedElementId: string, dictKey: string) {
