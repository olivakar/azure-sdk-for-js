...
export class MapInfoImpl implements MapInfo, TypeChecker {
  ...
  constructor(dtdlVersion: number, id: string, childOf: string|undefined, definedIn: string|undefined, entityKind: EntityKind = EntityKind.MAP) {
...
.add('dtmi:dtdl:class:Schema');
    ...
    this._badTypeActionFormat[2] = `Provide a value for property '{property}' with @type Map.`;
    this._badTypeActionFormat[3] = `Provide a value for property '{property}' with @type Map.`;
    this._badTypeCauseFormat[2] = `{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Map.`;
    this._badTypeCauseFormat[3] = `{primaryId:p} property '{property}' has value{secondaryId:e} that does not have @type of Map.`;
  }
  ...
  doesHaveType(typeId: string): boolean {
    return MapInfoImpl._versionlessTypes.has(new InDTMI(typeId).versionless) ||
this.supplementalTypes.some((st) => (st as SupplementalTypeInfoImpl).doesHaveType(typeId))
  ...
  static parseObject(model: Model, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], valueConstraints: ValueConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], object: {[index: string]: any}, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, dtmiSeg: string|undefined, keyProp: string|undefined, idRequired: boolean, typeRequired: boolean, allowIdReferenceSyntax: boolean, allowedVersions: Set<number>): any {
    // This is a method to parse the object read from DTDL into a type of MapInfo
    ...
    (elementInfo as MapInfoImpl).sourceObject = object;
    switch (childAggregateContext.dtdlVersion) {
    case 2: {
      (elementInfo as MapInfoImpl)?.parsePropertiesV2(model, objectPropertyInfoList, elementPropertyConstraints, childAggregateContext, parsingErrors, object, definedIn, allowIdReferenceSyntax);
      break;
    }

    case 3: {
      (elementInfo as MapInfoImpl)?.parsePropertiesV3(model, objectPropertyInfoList, elementPropertyConstraints, childAggregateContext, parsingErrors, object, definedIn, allowIdReferenceSyntax);
      break;
    }
    }
  ...
  static parseTypeArray(tokenArr: any[], elementId: string, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, aggregateContext: AggregateContext, parsingErrors: ParsingError[]): MapInfo|undefined {
    const materialKinds : EntityKind[] = [];
    const elementInfo : Reference<MapInfo> = referenceInit();
    ...
    for (const supplementalTypeId of supplementalTypeIds) {
      ...
      if (elementInfo.ref !== undefined && elementInfo.ref.entityKind !== undefined) {
        if (!(supplementalTypeInfo as SupplementalTypeInfoImpl)?.allowedCotypeKinds.includes(elementInfo.ref.entityKind)) {
          ...
          (elementInfo.ref as MapInfoImpl).addType(supplementalTypeId, supplementalTypeInfo);
        }
      }
    }
  ...
  static tryParseTypeStringV2(typestring: string, elementId: string, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, materialKinds: EntityKind[], supplementalTypeIds: string[], elementInfo: Reference<MapInfo>, undefinedTypes: string[], aggregateContext: AggregateContext, parsingErrors: ParsingError[]): boolean {
    switch (typestring) {
    case 'Map':
  ...
  parsePropertiesV2(model: Model, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], object: {[index: string]: any}, definedIn: string|undefined, allowIdReferenceSyntax: boolean): void {
    ...
    let mapValuePropertyMissing = true;
    for (const propKey in object) {
      ...
      case 'dtmi:dtdl:property:mapKey;2':
        ...
        valueCount = MapKeyInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._mapKeyValueConstraints, aggregateContext, parsingErrors, propValue, this.id, definedIn ?? this.id, 'mapKey', undefined, undefined, false, false, allowIdReferenceSyntax, this._mapKeyAllowedVersionsV2);
        if (valueCount < 1) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:propertyCountBelowMin',
            {
              cause: `{primaryId:p} property 'mapKey' has value valueCount values, but the required minimum count is 1`,
              action: `Add one or more 'mapKey' to the object until the minimum count is satisfied.`,
              primaryId: this.id,
              property: 'mapKey',
            }));
        }
        ...
        if (valueCount > 1) {
          parsingErrors.push(new ParsingError(
            ...
            {
              cause: `{primaryId:p} property 'mapKey' has value valueCount values, but the allowed maximum count is 1`,
              action: `Remove one or more 'mapKey' to the object until the maximum count is satisfied.`,
              primaryId: this.id,
              property: 'mapKey',
            }));
        }
      ...
      case 'dtmi:dtdl:property:mapValue;2':
        ...
        valueCount = MapValueInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._mapValueValueConstraints, aggregateContext, parsingErrors, propValue, this.id, definedIn ?? this.id, 'mapValue', undefined, undefined, false, false, allowIdReferenceSyntax, this._mapValueAllowedVersionsV2);
        if (valueCount < 1) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:propertyCountBelowMin',
            {
              cause: `{primaryId:p} property 'mapValue' has value valueCount values, but the required minimum count is 1`,
              action: `Add one or more 'mapValue' to the object until the minimum count is satisfied.`,
              primaryId: this.id,
              property: 'mapValue',
            }));
        }
        ...
        if (valueCount > 1) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:propertyCountAboveMax',
            {
              cause: `{primaryId:p} property 'mapValue' has value valueCount values, but the allowed maximum count is 1`,
              action: `Remove one or more 'mapValue' to the object until the maximum count is satisfied.`,
              primaryId: this.id,
              property: 'mapValue',
            }));
        }
    ...
    if (mapKeyPropertyMissing) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:missingRequiredProperty',
        {
          cause: '{primaryId:p} property mapKey is required but missing.',
          action: 'Add a mapKey property to the object.',
          primaryId: this.id,
          property: 'mapKey',
        }));
    }

    if (mapValuePropertyMissing) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:missingRequiredProperty',
        {
          cause: '{primaryId:p} property mapValue is required but missing.',
          action: 'Add a mapValue property to the object.',
          primaryId: this.id,
          property: 'mapValue',
        }));
    }
  ...
  parsePropertiesV3(model: Model, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], object: {[index: string]: any}, definedIn: string|undefined, allowIdReferenceSyntax: boolean): void {
    ...
    for (const propKey in object) {
      ...
      case 'dtmi:dtdl:property:mapKey;3':
        mapKeyPropertyMissing = false;
        valueCount = MapKeyInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._mapKeyValueConstraints, aggregateContext, parsingErrors, propValue, this.id, definedIn ?? this.id, 'mapKey', undefined, undefined, false, false, allowIdReferenceSyntax, this._mapKeyAllowedVersionsV3);
        if (valueCount < 1) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:propertyCountBelowMin',
            {
      ...
      case 'dtmi:dtdl:property:mapValue;3':
        mapValuePropertyMissing = false;
        valueCount = MapValueInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._mapValueValueConstraints, aggregateContext, parsingErrors, propValue, this.id, definedIn ?? this.id, 'mapValue', undefined, undefined, false, false, allowIdReferenceSyntax, this._mapValueAllowedVersionsV3);
        if (valueCount < 1) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:propertyCountBelowMin',
            {
  ...
  validateInstanceV2(instanceElt: any, instanceName: string|undefined): boolean {
    ...
    for (const [key, value] of Object.entries(instanceElt)) {
  ...
  checkRestrictionsV2(parsingErrors: ParsingError[]) {
    if (this._mapKeyInstanceProperties !== undefined) {
      for (const instanceProp of this._mapKeyInstanceProperties) {
        if (!(this.mapKey as MapKeyInfoImpl)?.validateInstanceElement(this.supplementalProperties[instanceProp])) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:nonConformantPropertyValue',
            {
              cause: '{{primaryId:n}} property \'{{property}}\' does not conform to the type specified by property \'mapKey\' ',
              action: 'Change the value of property \'{{property}}\' so that it conforms to property  \'mapKey\'',
              primaryId: this.id,
    ...
    if (this._mapValueInstanceProperties !== undefined) {
      for (const instanceProp of this._mapValueInstanceProperties) {
        if (!(this.mapValue as MapValueInfoImpl)?.validateInstanceElement(this.supplementalProperties[instanceProp])) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:nonConformantPropertyValue',
            {
              cause: '{{primaryId:n}} property \'{{property}}\' does not conform to the type specified by property \'mapValue\' ',
              action: 'Change the value of property \'{{property}}\' so that it conforms to property  \'mapValue\'',
              primaryId: this.id,
              property: instanceProp,
            }));
        }
    ...
    if (!this.checkDepthOfElementSchemaOrSchema(0, 5, tooDeepElementSchemaOrSchemaElementId, parsingErrors) && tooDeepElementSchemaOrSchemaElementId != undefined) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:excessiveDepth',
        {
...
**/
  checkDepthOfElementSchemaOrSchema(depth: number, depthLimit: number, tooDeepElementId: Reference<InDTMI>, parsingErrors: ParsingError[]): boolean {
    if (this.mapKey !== undefined) {
      if (!(this.mapKey as MapKeyInfoImpl).checkDepthOfElementSchemaOrSchema(depth, depthLimit, tooDeepElementId, parsingErrors)) {
    ...
    if (this.mapValue !== undefined) {
      if (!(this.mapValue as MapValueInfoImpl).checkDepthOfElementSchemaOrSchema(depth, depthLimit, tooDeepElementId, parsingErrors)) {
        if (tooDeepElementId.ref?.value === this.id) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:recursiveStructure',
            {
  ...
  checkDescendantEnumValueDataType(ancestorId: InDTMI, datatype: string, parsingErrors: ParsingError[]): void {
    ...
    if (this.mapKey !== undefined) {
      (this.mapKey as MapKeyInfoImpl).checkDescendantEnumValueDataType(ancestorId, datatype, parsingErrors);
    }

    if (this.mapValue !== undefined) {
      (this.mapValue as MapValueInfoImpl).checkDescendantEnumValueDataType(ancestorId, datatype, parsingErrors);
    }
  }
  ...
  tryGetDescendantSchemaArray(elementId: Reference<InDTMI>): boolean {
    ...
    if (this.mapKey !== undefined) {
      if ((this.mapKey as MapKeyInfoImpl).tryGetDescendantSchemaArray(elementId)) {
    ...
    if (this.mapValue !== undefined) {
      if ((this.mapValue as MapValueInfoImpl).tryGetDescendantSchemaArray(elementId)) {
        this._idOfDescendantSchemaArray = elementId.ref;
        return true;
      }
    }
  ...
  getCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(parsingErrors: ParsingError[]): number {
    ...
    if (this.mapValue !== undefined) {
      this._countOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrowValue += (this.mapValue as MapValueInfoImpl).getCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(parsingErrors) + 1;
    }
