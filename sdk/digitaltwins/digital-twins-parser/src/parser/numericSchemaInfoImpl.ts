...
export abstract class NumericSchemaInfoImpl implements NumericSchemaInfo, TypeChecker {
  ...
  public entityKind: NumericSchemaKinds;
  ...
  protected static _concreteKinds: {[x: number]: NumericSchemaKinds[]};
  ...
  constructor(dtdlVersion: number, id: string, childOf: string|undefined, definedIn: string|undefined, entityKind: NumericSchemaKinds) {
...
.add('dtmi:dtdl:class:Schema');
  ...
  static tryParseTypeStringV2(typestring: string, elementId: string, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, materialKinds: EntityKinds[], supplementalTypeIds: string[], elementInfo: Reference<NumericSchemaInfo>, undefinedTypes: string[], aggregateContext: AggregateContext, parsingErrors: ParsingError[]): boolean {
    switch (typestring) {
    case 'Double':
