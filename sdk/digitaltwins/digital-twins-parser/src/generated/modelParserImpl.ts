...
import {DtmiResolver, ElementPropertyConstraint, ModelParsingOption, ParsingError, ResolutionError, ParsingException, JsonSyntaxError} from '../parser';
...
export class ModelParserImpl implements ModelParser {
  ...
  static _parseObject(model: Model, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], object: any) {
  ...
  // get maxDtdlversion() {
  //   return this._maxDtdlVersion;
  // }

  // set maxDtdlVersion(value: number | undefined) {
  //   this._maxDtdlVersion = value;
  // }
  ...
  async parse(jsonTexts: string[]): Promise<ModelDict> {
    ...
    for (const elementPropertyConstraint of elementPropertyConstraints) {
      ...
      if (elementPropertyConstraint.valueConstraint.requiredTypes !== undefined && !elementPropertyConstraint.valueConstraint.requiredTypes.some((t) => (typeChecker as EntityInfoImpl)?.doesHaveType(t))) {
        // if (elementPropertyConstraint.valueConstraint.requiredTypes !== undefined && !elementPropertyConstraint.valueConstraint.requiredTypes.some((t) => model.doesHaveType(elementPropertyConstraint.elementId, t))) {
