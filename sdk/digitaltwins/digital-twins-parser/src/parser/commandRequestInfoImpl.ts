...
export class CommandRequestInfoImpl implements CommandRequestInfo, TypeChecker {
  ...
  doesHaveType(typeId: string): boolean {
    return (
      CommandRequestInfoImpl._versionlessTypes.has(new InDTMI(typeId).versionless) ||
  ...
  static parseObject(
    ...
    switch (childAggregateContext.dtdlVersion) {
      case 3: {
        (elementInfo as CommandRequestInfoImpl)?.parsePropertiesV3(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
    ...
    for (const supplementalTypeId of supplementalTypeIds) {
      ...
      if (elementInfo.ref !== undefined && elementInfo.ref.entityKind !== undefined) {
        if (
          ...
          (elementInfo.ref as CommandRequestInfoImpl).addType(
            supplementalTypeId,
  ...
  static tryParseTypeStringV3(
    ...
    elementInfo: Reference<CommandRequestInfo>,
