...
export class LongInfoImpl implements LongInfo, TypeChecker {
  ...
  doesHaveType(typeId: string): boolean {
    return (
      LongInfoImpl._versionlessTypes.has(new InDTMI(typeId).versionless) ||
  ...
  static parseObject(
    ...
    switch (childAggregateContext.dtdlVersion) {
      case 2: {
        (elementInfo as LongInfoImpl)?.parsePropertiesV2(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
      ...
      case 3: {
        (elementInfo as LongInfoImpl)?.parsePropertiesV3(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
  ...
  static tryParseTypeStringV2(
    ...
    elementInfo: Reference<LongInfo>,
  ...
  validateInstanceV2(instanceElt: any, instanceName: string | undefined): boolean {
    ...
    if (
      !Number.isInteger(instanceElt) ||
      (instanceElt >= -2147483648 && instanceElt <= 2147483647)
    ) {
      return false;
    }
