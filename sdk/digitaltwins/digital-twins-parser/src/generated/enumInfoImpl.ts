...
export class EnumInfoImpl implements EnumInfo, TypeChecker {
  ...
  constructor(dtdlVersion: number, id: string, childOf: string|undefined, definedIn: string|undefined, entityKind: EntityKind = EntityKind.ENUM) {
...
.add('dtmi:dtdl:class:Schema');
  ...
  doesHaveType(typeId: string): boolean {
    return EnumInfoImpl._versionlessTypes.has(new InDTMI(typeId).versionless) ||
this.supplementalTypes.some((st) => (st as SupplementalTypeInfoImpl).doesHaveType(typeId))
  ...
  static parseObject(model: Model, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], valueConstraints: ValueConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], object: {[index: string]: any}, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, dtmiSeg: string|undefined, keyProp: string|undefined, idRequired: boolean, typeRequired: boolean, allowIdReferenceSyntax: boolean, allowedVersions: Set<number>): any {
    ...
    case 2: {
      (elementInfo as EnumInfoImpl)?.parsePropertiesV2(model, objectPropertyInfoList, elementPropertyConstraints, childAggregateContext, parsingErrors, object, definedIn, allowIdReferenceSyntax);
      break;
    }

    case 3: {
      (elementInfo as EnumInfoImpl)?.parsePropertiesV3(model, objectPropertyInfoList, elementPropertyConstraints, childAggregateContext, parsingErrors, object, definedIn, allowIdReferenceSyntax);
      break;
    }
    }
  ...
  static parseTypeArray(tokenArr: any[], elementId: string, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, aggregateContext: AggregateContext, parsingErrors: ParsingError[]): EnumInfo|undefined {
  ...
  static tryParseTypeStringV2(typestring: string, elementId: string, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, materialKinds: EntityKind[], supplementalTypeIds: string[], elementInfo: Reference<EnumInfo>, undefinedTypes: string[], aggregateContext: AggregateContext, parsingErrors: ParsingError[]): boolean {
    switch (typestring) {
    case 'Enum':
  ...
  parsePropertiesV2(model: Model, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], object: {[index: string]: any}, definedIn: string|undefined, allowIdReferenceSyntax: boolean): void {
    ...
    for (const propKey in object) {
      ...
      case 'dtmi:dtdl:property:enumValues;2':
        valueCount = EnumValueInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._enumValuesValueConstraints, aggregateContext, parsingErrors, propValue, this.id, definedIn ?? this.id, 'enumValues', 'name', undefined, false, false, allowIdReferenceSyntax, this._enumValuesAllowedVersionsV2);
        if (valueCount < 1) {
          parsingErrors.push(new ParsingError(
      ...
      case 'dtmi:dtdl:property:valueSchema;2':
        ...
        valueCount = PrimitiveSchemaInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._valueSchemaValueConstraints, aggregateContext, parsingErrors, propValue, this.id, definedIn ?? this.id, 'valueSchema', undefined, undefined, true, true, allowIdReferenceSyntax, this._valueSchemaAllowedVersionsV2);
        if (valueCount < 1) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:propertyCountBelowMin',
            {
  ...
  parsePropertiesV3(model: Model, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], object: {[index: string]: any}, definedIn: string|undefined, allowIdReferenceSyntax: boolean): void {
    ...
    for (const propKey in object) {
      ...
      case 'dtmi:dtdl:property:enumValues;3':
        EnumValueInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._enumValuesValueConstraints, aggregateContext, parsingErrors, propValue, this.id, definedIn ?? this.id, 'enumValues', 'name', undefined, false, false, allowIdReferenceSyntax, this._enumValuesAllowedVersionsV3);
        continue;
      case 'valueSchema':
      case 'dtmi:dtdl:property:valueSchema;3':
        valueSchemaPropertyMissing = false;
        valueCount = PrimitiveSchemaInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._valueSchemaValueConstraints, aggregateContext, parsingErrors, propValue, this.id, definedIn ?? this.id, 'valueSchema', undefined, undefined, true, true, allowIdReferenceSyntax, this._valueSchemaAllowedVersionsV3);
        if (valueCount < 1) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:propertyCountBelowMin',
            {
  ...
  validateInstanceV2(instanceElt: any, instanceName: string|undefined): boolean {
    if (!(this.valueSchema as PrimitiveSchemaInfoImpl)?.validateInstanceInternal(instanceElt, instanceName)) {
      return false;
    }

    if (!this.enumValues?.some((val) => (val as EnumValueInfoImpl).validateInstanceInternal(instanceElt, instanceName))) {
      return false;
    }
...
**/
  ...
  checkRestrictionsV2(parsingErrors: ParsingError[]) {
    ...
    if (this.valueSchema !== undefined) {
      if (this.valueSchema.id !== 'dtmi:dtdl:instance:Schema:integer;2' && this.valueSchema.id !== 'dtmi:dtdl:instance:Schema:string;2') {
        parsingErrors.push(new ParsingError(
          'dtmi:dtdl:parsingError:incorrectPropertyValue',
          {
    ...
    if (this._valueSchemaInstanceProperties !== undefined) {
      for (const instanceProp of this._valueSchemaInstanceProperties) {
        if (!(this.valueSchema as PrimitiveSchemaInfoImpl)?.validateInstanceElement(this.supplementalProperties[instanceProp])) {
          parsingErrors.push(new ParsingError(
  ...
  checkRestrictionsV3(parsingErrors: ParsingError[]) {
    ...
    if (this.valueSchema !== undefined) {
      if (this.valueSchema.id !== 'dtmi:dtdl:instance:Schema:integer;3' && this.valueSchema.id !== 'dtmi:dtdl:instance:Schema:string;3') {
        parsingErrors.push(new ParsingError(
          'dtmi:dtdl:parsingError:incorrectPropertyValue',
          {
            cause: '{{primaryId:n}} property \'valueSchema\' has value {value} , but the value must be \'integer or string\'.',
...
**/
  checkDepthOfElementSchemaOrSchema(depth: number, depthLimit: number, tooDeepElementId: Reference<InDTMI>, parsingErrors: ParsingError[]): boolean {
    for (const item of this.enumValues || []) {
      if (!(item as EnumValueInfoImpl).checkDepthOfElementSchemaOrSchema(depth, depthLimit, tooDeepElementId, parsingErrors)) {
    ...
    if (this.valueSchema !== undefined) {
      if (!(this.valueSchema as PrimitiveSchemaInfoImpl).checkDepthOfElementSchemaOrSchema(depth, depthLimit, tooDeepElementId, parsingErrors)) {
        if (tooDeepElementId.ref?.value === this.id) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:recursiveStructure',
            {
  ...
  checkDescendantEnumValueDataType(ancestorId: InDTMI, datatype: string, parsingErrors: ParsingError[]): void {
    ...
    for (const item of this.enumValues || []) {
      (item as EnumValueInfoImpl).checkDescendantEnumValueDataType(ancestorId, datatype, parsingErrors);
    }

    if (this.valueSchema !== undefined) {
      (this.valueSchema as PrimitiveSchemaInfoImpl).checkDescendantEnumValueDataType(ancestorId, datatype, parsingErrors);
    }
  }
  ...
  tryGetDescendantSchemaArray(elementId: Reference<InDTMI>): boolean {
    ...
    if (this.valueSchema !== undefined) {
      if ((this.valueSchema as PrimitiveSchemaInfoImpl).tryGetDescendantSchemaArray(elementId)) {
        this._idOfDescendantSchemaArray = elementId.ref;
        return true;
      }
    }
  ...
  getCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(parsingErrors: ParsingError[]): number {
    ...
    for (const item of this.enumValues || []) {
      this._countOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrowValue += (item as EnumValueInfoImpl).getCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(parsingErrors) + 1;
    }
