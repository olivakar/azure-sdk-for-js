...
import {SchemaKinds} from './internal';
...
export abstract class SchemaInfoImpl implements SchemaInfo, TypeChecker {
  ...
  protected static _concreteKinds: {[x: number]: SchemaKinds[]};
  ...
  constructor(dtdlVersion: number, id: string, childOf: string|undefined, definedIn: string|undefined, entityKind: SchemaKinds) {
...
.add('dtmi:dtdl:class:Schema');
  ...
  static tryParseTypeStringV2(typestring: string, elementId: string, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, materialKinds: EntityKinds[], supplementalTypeIds: string[], elementInfo: Reference<SchemaInfo>, undefinedTypes: string[], aggregateContext: AggregateContext, parsingErrors: ParsingError[]): boolean {
    switch (typestring) {
    case 'Array':
