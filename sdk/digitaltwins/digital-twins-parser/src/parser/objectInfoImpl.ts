...
export class ObjectInfoImpl implements ObjectInfo, TypeChecker {
  ...
  static parseObject(
    ...
    switch (childAggregateContext.dtdlVersion) {
      case 2: {
        (elementInfo as ObjectInfoImpl)?.parsePropertiesV2(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
      ...
      case 3: {
        (elementInfo as ObjectInfoImpl)?.parsePropertiesV3(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
  ...
  static tryParseTypeStringV2(
    ...
    elementInfo: Reference<ObjectInfo>,
    ...
    for (const propKey in object) {
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:fields;2":
          valueCount = FieldInfoImpl.parseToken(
            model,
            objectPropertyInfoList,
            elementPropertyConstraints,
            this._fieldsValueConstraints,
            aggregateContext,
            parsingErrors,
            propValue,
            this.id,
