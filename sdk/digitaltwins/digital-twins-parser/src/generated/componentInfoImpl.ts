...
import {ComponentInfo} from './internal';
...
export class ComponentInfoImpl implements ComponentInfo, TypeChecker {
  ...
  constructor(dtdlVersion: number, id: string, childOf: string|undefined, definedIn: string|undefined, entityKind: EntityKind = EntityKind.COMPONENT) {
...
.add('dtmi:dtdl:class:NamedEntity');
  ...
  doesHaveType(typeId: string): boolean {
    return ComponentInfoImpl._versionlessTypes.has(new InDTMI(typeId).versionless) ||
this.supplementalTypes.some((st) => (st as SupplementalTypeInfoImpl).doesHaveType(typeId))
  ...
  static parseObject(model: Model, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], valueConstraints: ValueConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], object: {[index: string]: any}, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, dtmiSeg: string|undefined, keyProp: string|undefined, idRequired: boolean, typeRequired: boolean, allowIdReferenceSyntax: boolean, allowedVersions: Set<number>): any {
    ...
    case 2: {
      (elementInfo as ComponentInfoImpl)?.parsePropertiesV2(model, objectPropertyInfoList, elementPropertyConstraints, childAggregateContext, parsingErrors, object, definedIn, allowIdReferenceSyntax);
      break;
    }

    case 3: {
      (elementInfo as ComponentInfoImpl)?.parsePropertiesV3(model, objectPropertyInfoList, elementPropertyConstraints, childAggregateContext, parsingErrors, object, definedIn, allowIdReferenceSyntax);
      break;
    }
    }
  ...
  static parseTypeArray(tokenArr: any[], elementId: string, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, aggregateContext: AggregateContext, parsingErrors: ParsingError[]): ComponentInfo|undefined {
  ...
  static tryParseTypeStringV2(typestring: string, elementId: string, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, materialKinds: EntityKind[], supplementalTypeIds: string[], elementInfo: Reference<ComponentInfo>, undefinedTypes: string[], aggregateContext: AggregateContext, parsingErrors: ParsingError[]): boolean {
    switch (typestring) {
    case 'Component':
  ...
  parsePropertiesV2(model: Model, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], object: {[index: string]: any}, definedIn: string|undefined, allowIdReferenceSyntax: boolean): void {
    ...
    for (const propKey in object) {
      ...
      case 'dtmi:dtdl:property:schema;2':
        ...
        valueCount = InterfaceInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._schemaValueConstraints, aggregateContext, parsingErrors, propValue, this.id, definedIn ?? this.id, 'schema', undefined, undefined, true, true, allowIdReferenceSyntax, this._schemaAllowedVersionsV2);
        if (valueCount < 1) {
          parsingErrors.push(new ParsingError(
  ...
  parsePropertiesV3(model: Model, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], object: {[index: string]: any}, definedIn: string|undefined, allowIdReferenceSyntax: boolean): void {
    ...
    for (const propKey in object) {
      ...
      case 'dtmi:dtdl:property:schema;3':
        schemaPropertyMissing = false;
        valueCount = InterfaceInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._schemaValueConstraints, aggregateContext, parsingErrors, propValue, this.id, definedIn ?? this.id, 'schema', undefined, undefined, true, true, allowIdReferenceSyntax, this._schemaAllowedVersionsV3);
        if (valueCount < 1) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:propertyCountBelowMin',
            {
...
**/
  setPartitionInfo(partitionJsonText: string): void {
    throw new Error(`attempt to set partition info on non-partition type ComponentInfoInfo`);
  }
  ...
  checkRestrictionsV2(parsingErrors: ParsingError[]) {
    if (this._schemaInstanceProperties !== undefined) {
      for (const instanceProp of this._schemaInstanceProperties) {
        if (!(this.schema as InterfaceInfoImpl)?.validateInstanceElement(this.supplementalProperties[instanceProp])) {
          parsingErrors.push(new ParsingError(
    ...
    const excludedComponentElementId: Reference<InDTMI> = {ref: undefined};
    this.tryGetDescendantSchemaOrContentsComponentNarrow(excludedComponentElementId);
    if (excludedComponentElementId.ref !== undefined) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:excludedType',
        {
          cause: `{primaryId:n} contains Component{secondaryId:e}, which is not allowed in 'schema' or 'contents' properties under elements of type {typeName}.`,
          action: `Remove the elements of type Component from 'schema' or 'contents' properties under the element of type Component.`,
          primaryId: this.id,
          secondaryId: excludedComponentElementId.ref.value,
        }));
    }
  }
  ...
  trySetObjectProperty(propertyName: string, value: any, key: string|undefined): boolean {
    ...
    case 'dtmi:dtdl:property:schema;2':
    case 'dtmi:dtdl:property:schema;3':
      this.schema = value as InterfaceInfoImpl;
      return true;
    default:
      break;
    }
...
**/
  checkDepthOfElementSchemaOrSchema(depth: number, depthLimit: number, tooDeepElementId: Reference<InDTMI>, parsingErrors: ParsingError[]): boolean {
    ...
    if (this.schema !== undefined) {
      if (!(this.schema as InterfaceInfoImpl).checkDepthOfElementSchemaOrSchema(depth + 1, depthLimit, tooDeepElementId, parsingErrors)) {
  ...
  tryGetDescendantSchemaOrContentsComponentNarrow(elementId: Reference<InDTMI>): boolean {
    ...
    if (this.schema !== undefined) {
      if ((this.schema as InterfaceInfoImpl).entityKind === EntityKind.COMPONENT) {
        elementId.ref = new InDTMI((this.schema as InterfaceInfoImpl).id);
        this._idOfDescendantSchemaOrContentsComponentNarrow = elementId.ref;
        return true;
      }

      if ((this.schema as InterfaceInfoImpl).tryGetDescendantSchemaOrContentsComponentNarrow(elementId)) {
        this._idOfDescendantSchemaOrContentsComponentNarrow = elementId.ref;
        return true;
      }
    }
  ...
  checkDescendantEnumValueDataType(ancestorId: InDTMI, datatype: string, parsingErrors: ParsingError[]): void {
    ...
    if (this.schema !== undefined) {
      (this.schema as InterfaceInfoImpl).checkDescendantEnumValueDataType(ancestorId, datatype, parsingErrors);
    }
  }
  ...
  tryGetDescendantSchemaArray(elementId: Reference<InDTMI>): boolean {
    ...
    if (this.schema !== undefined) {
      if ((this.schema as InterfaceInfoImpl).entityKind === EntityKind.ARRAY) {
        elementId.ref = new InDTMI((this.schema as InterfaceInfoImpl).id);
        this._idOfDescendantSchemaArray = elementId.ref;
        return true;
      }

      if ((this.schema as InterfaceInfoImpl).tryGetDescendantSchemaArray(elementId)) {
        this._idOfDescendantSchemaArray = elementId.ref;
        return true;
      }
    }
  ...
  getCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(parsingErrors: ParsingError[]): number {
    ...
    if (this.schema !== undefined) {
      this._countOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrowValue += (this.schema as InterfaceInfoImpl).getCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(parsingErrors) + 1;
    }
