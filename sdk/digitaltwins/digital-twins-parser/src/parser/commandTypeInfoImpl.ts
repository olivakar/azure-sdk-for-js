...
export class CommandTypeInfoImpl implements CommandTypeInfo, TypeChecker {
  ...
  doesHaveType(typeId: string): boolean {
    return (
      CommandTypeInfoImpl._versionlessTypes.has(new InDTMI(typeId).versionless) ||
  ...
  static parseObject(
    ...
    switch (childAggregateContext.dtdlVersion) {
      case 2: {
        (elementInfo as CommandTypeInfoImpl)?.parsePropertiesV2(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
      ...
      case 3: {
        (elementInfo as CommandTypeInfoImpl)?.parsePropertiesV3(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
    ...
    for (const supplementalTypeId of supplementalTypeIds) {
      ...
      if (elementInfo.ref !== undefined && elementInfo.ref.entityKind !== undefined) {
        if (
          ...
          (elementInfo.ref as CommandTypeInfoImpl).addType(
            supplementalTypeId,
  ...
  static tryParseTypeStringV2(
    ...
    elementInfo: Reference<CommandTypeInfo>,
