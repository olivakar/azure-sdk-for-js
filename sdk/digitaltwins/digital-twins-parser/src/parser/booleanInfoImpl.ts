...
export class BooleanInfoImpl implements BooleanInfo, TypeChecker {
  ...
  public entityKind: BooleanKinds;
  ...
  protected static _concreteKinds: {[x: number]: BooleanKinds[]};
  ...
  constructor(dtdlVersion: number, id: string, childOf: string|undefined, definedIn: string|undefined, entityKind: BooleanKinds) {
