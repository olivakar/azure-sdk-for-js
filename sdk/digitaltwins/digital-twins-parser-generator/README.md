...
### Install the `digital-twins-parser-generator` package

Install the Digital Twins Model Parser client library for JavaScript with `npm`:

```bash
npm install digital-twins-parser-generator
```
...
```ts
import {CodeGenerator} from 'digital-twins-parser-generator';
...
Please take a look at the [samples](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/digital-twins/digital-twins-parser-generator/samples) directory for detailed examples that demonstrate how to use the client libraries.
