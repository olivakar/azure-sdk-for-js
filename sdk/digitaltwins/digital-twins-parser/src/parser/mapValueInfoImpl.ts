...
export class MapValueInfoImpl implements MapValueInfo, TypeChecker {
  ...
  doesHaveType(typeId: string): boolean {
    return (
      MapValueInfoImpl._versionlessTypes.has(new InDTMI(typeId).versionless) ||
  ...
  static parseObject(
    ...
    switch (childAggregateContext.dtdlVersion) {
      case 2: {
        (elementInfo as MapValueInfoImpl)?.parsePropertiesV2(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
      ...
      case 3: {
        (elementInfo as MapValueInfoImpl)?.parsePropertiesV3(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
  ...
  static tryParseTypeStringV2(
    ...
    elementInfo: Reference<MapValueInfo>,
