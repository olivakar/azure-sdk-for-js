...
import {CommandResponseKinds} from './internal';
...
export class CommandResponseInfoImpl implements CommandResponseInfo, TypeChecker {
  ...
  public entityKind: CommandResponseKinds;
  ...
  protected static _concreteKinds: {[x: number]: CommandResponseKinds[]};
  ...
  constructor(dtdlVersion: number, id: string, childOf: string|undefined, definedIn: string|undefined, entityKind: CommandResponseKinds) {
...
this.supplementalTypes.some((st) => (st as SupplementalTypeInfoImpl).doesHaveType(typeId))
  ...
  static tryParseTypeStringV3(typestring: string, elementId: string, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, materialKinds: EntityKinds[], supplementalTypeIds: string[], elementInfo: Reference<CommandResponseInfo>, undefinedTypes: string[], aggregateContext: AggregateContext, parsingErrors: ParsingError[]): boolean {
    switch (typestring) {
    case 'CommandResponse':
    case 'dtmi:dtdl:class:CommandResponse;3':
      elementInfo.ref = new CommandResponseInfoImpl(3, elementId, parentId, definedIn, 'commandresponse');
