...
export abstract class NamedEntityInfoImpl implements NamedEntityInfo, TypeChecker {
  ...
  public entityKind: NamedEntityKinds;
  ...
  protected static _concreteKinds: {[x: number]: NamedEntityKinds[]};
  ...
  constructor(dtdlVersion: number, id: string, childOf: string|undefined, definedIn: string|undefined, entityKind: NamedEntityKinds) {
...
.add('dtmi:dtdl:class:NamedEntity');
  ...
  static tryParseTypeStringV2(typestring: string, elementId: string, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, materialKinds: EntityKinds[], supplementalTypeIds: string[], elementInfo: Reference<NamedEntityInfo>, undefinedTypes: string[], aggregateContext: AggregateContext, parsingErrors: ParsingError[]): boolean {
    switch (typestring) {
    case 'Command':
    ...
    if (supplementalTypeId !== undefined) {
      ...
      case ExtensionKind.UNITATTRIBUTE:
        elementInfo.ref = new UnitAttributeInfoImpl(2, elementId, parentId, definedIn, 'unitattribute');
  ...
  static tryParseTypeStringV3(typestring: string, elementId: string, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, materialKinds: EntityKinds[], supplementalTypeIds: string[], elementInfo: Reference<NamedEntityInfo>, undefinedTypes: string[], aggregateContext: AggregateContext, parsingErrors: ParsingError[]): boolean {
    ...
    if (supplementalTypeId !== undefined) {
      ...
      case ExtensionKind.NAMEDLATENTTYPE:
        elementInfo.ref = new NamedLatentTypeInfoImpl(3, elementId, parentId, definedIn, 'namedlatenttype');
      ...
      case ExtensionKind.UNIT:
        ...
        break;
      case ExtensionKind.UNITATTRIBUTE:
        elementInfo.ref = new UnitAttributeInfoImpl(3, elementId, parentId, definedIn, 'unitattribute');
        (elementInfo.ref as UnitAttributeInfoImpl).addType(supplementalTypeId.value, supplementalTypeInfo);
        materialKinds.push('unitattribute');
        return true;
      }
