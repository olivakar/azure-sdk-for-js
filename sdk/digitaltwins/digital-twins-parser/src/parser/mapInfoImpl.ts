...
export class MapInfoImpl implements MapInfo, TypeChecker {
  ...
  static parseObject(
    ...
    switch (childAggregateContext.dtdlVersion) {
      case 2: {
        (elementInfo as MapInfoImpl)?.parsePropertiesV2(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
      ...
      case 3: {
        (elementInfo as MapInfoImpl)?.parsePropertiesV3(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
    ...
    for (const propKey in object) {
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:mapKey;2":
          ...
          valueCount = MapKeyInfoImpl.parseToken(
            model,
            objectPropertyInfoList,
            elementPropertyConstraints,
            this._mapKeyValueConstraints,
            aggregateContext,
            parsingErrors,
            propValue,
            this.id,
        ...
        case "dtmi:dtdl:property:mapValue;2":
          ...
          valueCount = MapValueInfoImpl.parseToken(
            model,
            objectPropertyInfoList,
            elementPropertyConstraints,
            this._mapValueValueConstraints,
            aggregateContext,
            parsingErrors,
            propValue,
            this.id,
            ...
            false,
            allowIdReferenceSyntax,
            this._mapValueAllowedVersionsV2
          );
          if (valueCount < 1) {
            parsingErrors.push(
              createParsingError("dtmi:dtdl:parsingError:propertyCountBelowMin", {
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:mapValue;3":
          ...
          valueCount = MapValueInfoImpl.parseToken(
            ...
            false,
            allowIdReferenceSyntax,
            this._mapValueAllowedVersionsV3
          );
          if (valueCount < 1) {
            parsingErrors.push(
              createParsingError("dtmi:dtdl:parsingError:propertyCountBelowMin", {
