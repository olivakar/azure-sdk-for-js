...
import {AggregateContext, ElementPropertyConstraint, ParsedObjectPropertyInfo, ParsingError, PropertyInstanceBinder, PropertyValueConstrainer, SupplementalTypeInfo, SupplementalPropertyInfoImpl, ValueConstraint} from '../parser/internal';
 ...
 */
export class SupplementalTypeInfoImpl {
