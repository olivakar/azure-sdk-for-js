...
export class TimeInfoImpl implements TimeInfo, TypeChecker {
  ...
  doesHaveType(typeId: string): boolean {
    return (
      TimeInfoImpl._versionlessTypes.has(new InDTMI(typeId).versionless) ||
  ...
  static parseObject(
    ...
    switch (childAggregateContext.dtdlVersion) {
      case 2: {
        (elementInfo as TimeInfoImpl)?.parsePropertiesV2(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
      ...
      case 3: {
        (elementInfo as TimeInfoImpl)?.parsePropertiesV3(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
  ...
  static tryParseTypeStringV2(
    ...
    elementInfo: Reference<TimeInfo>,
