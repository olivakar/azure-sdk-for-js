...
export abstract class TemporalSchemaInfoImpl implements TemporalSchemaInfo, TypeChecker {
  ...
  static parseObject(
    ...
    switch (childAggregateContext.dtdlVersion) {
      case 2: {
        (elementInfo as TemporalSchemaInfoImpl)?.parsePropertiesV2(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
      ...
      case 3: {
        (elementInfo as TemporalSchemaInfoImpl)?.parsePropertiesV3(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
    ...
    for (const supplementalTypeId of supplementalTypeIds) {
      ...
      if (elementInfo.ref !== undefined && elementInfo.ref.entityKind !== undefined) {
        if (
          ...
          (elementInfo.ref as TemporalSchemaInfoImpl).addType(
            supplementalTypeId,
  ...
  static tryParseTypeStringV2(
    ...
    elementInfo: Reference<TemporalSchemaInfo>,
