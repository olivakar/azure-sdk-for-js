...
describe('Tests of ValueParser class', function() {
  describe('Test parseSingularStringToken method', function() {
    it('detects stringNoValue', function() {
      ...
      ValueParser.parseSingularStringToken(elementId, propertyName, token, maxLength, pattern, parsingErrors);
    ...
    it('succeeds with string', function() {
      ...
      const pattern = undefined;
      const parsingErrors: ParsingError[] = [];
      expect(ValueParser.parseSingularStringToken(elementId, propertyName, token, maxLength, pattern, parsingErrors)).to.equal(token);
    ...
    it('succeeds with string object', function() {
      ...
      const pattern = undefined;
      const parsingErrors: ParsingError[] = [];
      expect(ValueParser.parseSingularStringToken(elementId, propertyName, token, maxLength, pattern, parsingErrors)).to.equal(token['@value']);
      expect(parsingErrors).to.have.lengthOf(0);
    });
    ...
    it('succeeds with string in array', function() {
      ...
      const pattern = undefined;
      const parsingErrors: ParsingError[] = [];
      expect(ValueParser.parseSingularStringToken(elementId, propertyName, token, maxLength, pattern, parsingErrors)).to.equal(token[0]);
      expect(parsingErrors).to.have.lengthOf(0);
    });
  });
  ...
  describe('Test parseSingularIntegerToken method', function() {
    it('detects integerNoValue', function() {
      ...
      const parsingErrors: ParsingError[] = [];
      ValueParser.parseSingularIntegerToken(elementId, propertyName, token, minInclusive, maxInclusive, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
    ...
    it('detects integerValueNotInteger', function() {
      ...
      ValueParser.parseSingularIntegerToken(elementId, propertyName, token, minInclusive, maxInclusive, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
      expect(parsingErrors[0].validationId).to.equal('dtmi:dtdl:parsingError:integerValueNotInteger');
    });
    ...
    it('detects integerMultipleValues in array', function() {
      ...
      ValueParser.parseSingularIntegerToken(elementId, propertyName, token, minInclusive, maxInclusive, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
      expect(parsingErrors[0].validationId).to.equal('dtmi:dtdl:parsingError:integerMultipleValues');
    });
    ...
    it('succeeds with integer', function() {
      ...
      const maxInclusive = undefined;
      const parsingErrors: ParsingError[] = [];
      expect(ValueParser.parseSingularIntegerToken(elementId, propertyName, token, minInclusive, maxInclusive, parsingErrors)).to.equal(token);
      expect(parsingErrors).to.have.lengthOf(0);
    });
    ...
    it('succeeds with integer object', function() {
      ...
      const maxInclusive = undefined;
      const parsingErrors: ParsingError[] = [];
      expect(ValueParser.parseSingularIntegerToken(elementId, propertyName, token, minInclusive, maxInclusive, parsingErrors)).to.equal(token['@value']);
      expect(parsingErrors).to.have.lengthOf(0);
    });
    ...
    it('succeeds with integer in array', function() {
      ...
      const maxInclusive = undefined;
      const parsingErrors: ParsingError[] = [];
      expect(ValueParser.parseSingularIntegerToken(elementId, propertyName, token, minInclusive, maxInclusive, parsingErrors)).to.equal(token[0]);
      expect(parsingErrors).to.have.lengthOf(0);
    });
  });
  ...
  describe('Test parseSingularBooleanToken method', function() {
    ...
    it('detects booleanValueNotBoolean', function() {
      ...
      ValueParser.parseSingularBooleanToken(elementId, propertyName, token, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
      expect(parsingErrors[0].validationId).to.equal('dtmi:dtdl:parsingError:booleanValueNotBoolean');
    });
    ...
    it('detects booleanMultipleValues in array', function() {
      ...
      ValueParser.parseSingularBooleanToken(elementId, propertyName, token, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
      expect(parsingErrors[0].validationId).to.equal('dtmi:dtdl:parsingError:booleanMultipleValues');
    });
    ...
    it('succeeds with true', function() {
      ...
      const token = true;
      const parsingErrors: ParsingError[] = [];
      expect(ValueParser.parseSingularBooleanToken(elementId, propertyName, token, parsingErrors)).to.be.true;
      expect(parsingErrors).to.have.lengthOf(0);
    });
    ...
    it('succeeds with false', function() {
      ...
      const token = false;
      const parsingErrors: ParsingError[] = [];
      expect(ValueParser.parseSingularBooleanToken(elementId, propertyName, token, parsingErrors)).to.be.false;
      expect(parsingErrors).to.have.lengthOf(0);
    });
  ...
  describe('Test parseLangStringToken method', function() {
    it('detects langStringNoValue', function() {
      ...
      const pattern = undefined;
      const parsingErrors: ParsingError[] = [];
      ValueParser.parseLangStringToken(elementId, propertyName, token, defaultLang, maxLength, pattern, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
    ...
    it('detects langStringInvalidCode', function() {
      ...
      ValueParser.parseLangStringToken(elementId, propertyName, token, defaultLang, maxLength, pattern, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
      expect(parsingErrors[0].validationId).to.equal('dtmi:dtdl:parsingError:langStringInvalidCode');
    });
    ...
    it('detects langStringValueNotString', function() {
      ...
      ValueParser.parseLangStringToken(elementId, propertyName, token, defaultLang, maxLength, pattern, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
      expect(parsingErrors[0].validationId).to.equal('dtmi:dtdl:parsingError:langStringValueNotString');
    });
    ...
    it('detects langStringElementNotObject in array', function() {
      ...
      ValueParser.parseLangStringToken(elementId, propertyName, token, defaultLang, maxLength, pattern, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
      expect(parsingErrors[0].validationId).to.equal('dtmi:dtdl:parsingError:langStringElementNotObject');
    });
    ...
    it('detects langStringElementNoCode in array', function() {
      ...
      ValueParser.parseLangStringToken(elementId, propertyName, token, defaultLang, maxLength, pattern, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
      expect(parsingErrors[0].validationId).to.equal('dtmi:dtdl:parsingError:langStringElementNoCode');
    });

    it('detects langStringElementCodeNotString in array', function() {
      const elementId = 'dtmi:test:id0;1';
      const propertyName = 'testProp';
      const token = [{'@language': 626, '@value': 'The quick brown fox jumps over the lazy dog.'}];
      const defaultLang = 'en';
      const maxLength = undefined;
      const pattern = undefined;
      const parsingErrors: ParsingError[] = [];
      ValueParser.parseLangStringToken(elementId, propertyName, token, defaultLang, maxLength, pattern, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
      expect(parsingErrors[0].validationId).to.equal('dtmi:dtdl:parsingError:langStringElementCodeNotString');
    });

    it('detects langStringElementInvalidCode in array', function() {
      const elementId = 'dtmi:test:id0;1';
      const propertyName = 'testProp';
      const token = [{'@language': 'esperanto', '@value': 'The quick brown fox jumps over the lazy dog.'}];
      const defaultLang = 'en';
      const maxLength = undefined;
      const pattern = undefined;
      const parsingErrors: ParsingError[] = [];
      ValueParser.parseLangStringToken(elementId, propertyName, token, defaultLang, maxLength, pattern, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
      expect(parsingErrors[0].validationId).to.equal('dtmi:dtdl:parsingError:langStringElementInvalidCode');
    });
    ...
    it('detects langStringElementCodeNotUnique in array', function() {
      ...
      ValueParser.parseLangStringToken(elementId, propertyName, token, defaultLang, maxLength, pattern, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
      expect(parsingErrors[0].validationId).to.equal('dtmi:dtdl:parsingError:langStringElementCodeNotUnique');
    });
    ...
    it('detects langStringElementNoValue in array', function() {
      ...
      ValueParser.parseLangStringToken(elementId, propertyName, token, defaultLang, maxLength, pattern, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
      expect(parsingErrors[0].validationId).to.equal('dtmi:dtdl:parsingError:langStringElementNoValue');
    });
    ...
    it('detects langStringElementValueNotString in array', function() {
      ...
      ValueParser.parseLangStringToken(elementId, propertyName, token, defaultLang, maxLength, pattern, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
      expect(parsingErrors[0].validationId).to.equal('dtmi:dtdl:parsingError:langStringElementValueNotString');
    });
    ...
    it('detects langStringNotLangString', function() {
      ...
      ValueParser.parseLangStringToken(elementId, propertyName, token, defaultLang, maxLength, pattern, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
      expect(parsingErrors[0].validationId).to.equal('dtmi:dtdl:parsingError:langStringNotLangString');
    });
    ...
    it('detects langStringValueTooLong', function() {
      ...
      ValueParser.parseLangStringToken(elementId, propertyName, token, defaultLang, maxLength, pattern, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
      expect(parsingErrors[0].validationId).to.equal('dtmi:dtdl:parsingError:langStringValueTooLong');
    });
    ...
    it('detects langStringValueInvalid', function() {
      ...
      ValueParser.parseLangStringToken(elementId, propertyName, token, defaultLang, maxLength, pattern, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
      expect(parsingErrors[0].validationId).to.equal('dtmi:dtdl:parsingError:langStringValueInvalid');
    });
    ...
    it('succeeds with string', function() {
      ...
      const pattern = undefined;
      const parsingErrors: ParsingError[] = [];
      expect(ValueParser.parseLangStringToken(elementId, propertyName, token, defaultLang, maxLength, pattern, parsingErrors)).to.deep.equal({'en': 'The quick brown fox jumps over the lazy dog.'});
      expect(parsingErrors).to.have.lengthOf(0);
    });
    ...
    it('succeeds with object', function() {
      ...
      const pattern = undefined;
      const parsingErrors: ParsingError[] = [];
      expect(ValueParser.parseLangStringToken(elementId, propertyName, token, defaultLang, maxLength, pattern, parsingErrors)).to.deep.equal({'es': 'The quick brown fox jumps over the lazy dog.'});
      expect(parsingErrors).to.have.lengthOf(0);
    });
    ...
    it('succeeds with array', function() {
      const elementId = 'dtmi:test:id0;1';
      const propertyName = 'testProp';
      const token = [{'@language': 'es', '@value': 'The quick brown fox jumps over the lazy dog.'}];
      const defaultLang = 'en';
      const maxLength = undefined;
      const pattern = undefined;
      const parsingErrors: ParsingError[] = [];
    ...
    it('succeeds with empty array', function() {
      ...
      const pattern = undefined;
      const parsingErrors: ParsingError[] = [];
      expect(ValueParser.parseLangStringToken(elementId, propertyName, token, defaultLang, maxLength, pattern, parsingErrors)).to.deep.equal({});
      expect(parsingErrors).to.have.lengthOf(0);
    });
  });
  ...
  describe('Test parseSingularLiteralToken method', function() {
    ...
    it('detects literalMultipleValues in array', function() {
      ...
      ValueParser.parseSingularLiteralToken(elementId, propertyName, token, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
      expect(parsingErrors[0].validationId).to.equal('dtmi:dtdl:parsingError:literalMultipleValues');
    });
    ...
    it('succeeds with string', function() {
      ...
      const token = 'foo';
      const parsingErrors: ParsingError[] = [];
      const {value, typeFragment} = ValueParser.parseSingularLiteralToken(elementId, propertyName, token, parsingErrors);
  ...
  describe('Test parseSingularIdentifierToken method', function() {
    it('detects identifierNoValue', function() {
      ...
      const pattern = undefined;
      const parsingErrors: ParsingError[] = [];
      ValueParser.parseSingularIdentifierToken(elementId, propertyName, token, maxLength, pattern, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
    ...
    it('detects identifierMultipleValues in array', function() {
      ...
      ValueParser.parseSingularIdentifierToken(elementId, propertyName, token, maxLength, pattern, parsingErrors);
      expect(parsingErrors).to.have.lengthOf(1);
      expect(parsingErrors[0].validationId).to.equal('dtmi:dtdl:parsingError:identifierMultipleValues');
    });
    ...
    it('succeeds with identifier', function() {
      ...
      const pattern = /^dtmi[A-Za-z:]+;\d+.\d+$/;
      const parsingErrors: ParsingError[] = [];
      expect(ValueParser.parseSingularIdentifierToken(elementId, propertyName, token, maxLength, pattern, parsingErrors)).to.equal(token);
      expect(parsingErrors).to.have.lengthOf(0);
    });
    ...
    it('succeeds with identifier in array', function() {
      ...
      const pattern = /^dtmi[A-Za-z:]+;\d+.\d+$/;
      const parsingErrors: ParsingError[] = [];
      expect(ValueParser.parseSingularIdentifierToken(elementId, propertyName, token, maxLength, pattern, parsingErrors)).to.equal(token[0]);
      expect(parsingErrors).to.have.lengthOf(0);
    });
  });
});
