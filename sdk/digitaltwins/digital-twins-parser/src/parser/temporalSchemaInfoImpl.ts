...
import {TemporalSchemaKinds} from './internal';
...
export abstract class TemporalSchemaInfoImpl implements TemporalSchemaInfo, TypeChecker {
  ...
  protected static _concreteKinds: {[x: number]: TemporalSchemaKinds[]};
  ...
  constructor(dtdlVersion: number, id: string, childOf: string|undefined, definedIn: string|undefined, entityKind: TemporalSchemaKinds) {
...
.add('dtmi:dtdl:class:TemporalSchema');
  ...
  static tryParseTypeStringV2(typestring: string, elementId: string, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, materialKinds: EntityKinds[], supplementalTypeIds: string[], elementInfo: Reference<TemporalSchemaInfo>, undefinedTypes: string[], aggregateContext: AggregateContext, parsingErrors: ParsingError[]): boolean {
    switch (typestring) {
    case 'Date':
