...
export class InterfaceInfoImpl implements InterfaceInfo, TypeChecker {
  ...
  constructor(dtdlVersion: number, id: string, childOf: string|undefined, definedIn: string|undefined, entityKind: EntityKind = EntityKind.INTERFACE) {
...
.add('dtmi:dtdl:class:Interface');
  ...
  doesHaveType(typeId: string): boolean {
    return InterfaceInfoImpl._versionlessTypes.has(new InDTMI(typeId).versionless) ||
this.supplementalTypes.some((st) => (st as SupplementalTypeInfoImpl).doesHaveType(typeId))
  ...
  static parseObject(model: Model, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], valueConstraints: ValueConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], object: {[index: string]: any}, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, dtmiSeg: string|undefined, keyProp: string|undefined, idRequired: boolean, typeRequired: boolean, allowIdReferenceSyntax: boolean, allowedVersions: Set<number>): any {
    ...
    case 2: {
      (elementInfo as InterfaceInfoImpl)?.parsePropertiesV2(model, objectPropertyInfoList, elementPropertyConstraints, childAggregateContext, parsingErrors, object, definedIn, allowIdReferenceSyntax);
      break;
    }

    case 3: {
      (elementInfo as InterfaceInfoImpl)?.parsePropertiesV3(model, objectPropertyInfoList, elementPropertyConstraints, childAggregateContext, parsingErrors, object, definedIn, allowIdReferenceSyntax);
      break;
    }
    }
  ...
  static parseTypeArray(tokenArr: any[], elementId: string, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, aggregateContext: AggregateContext, parsingErrors: ParsingError[]): InterfaceInfo|undefined {
  ...
  static tryParseTypeStringV2(typestring: string, elementId: string, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, materialKinds: EntityKind[], supplementalTypeIds: string[], elementInfo: Reference<InterfaceInfo>, undefinedTypes: string[], aggregateContext: AggregateContext, parsingErrors: ParsingError[]): boolean {
    switch (typestring) {
    case 'Interface':
  ...
  parsePropertiesV2(model: Model, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], object: {[index: string]: any}, definedIn: string|undefined, allowIdReferenceSyntax: boolean): void {
    ...
    for (const propKey in object) {
      ...
      case 'dtmi:dtdl:property:contents;2':
        valueCount = ContentInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._contentsValueConstraints, aggregateContext, parsingErrors, propValue, this.id, this.id, 'contents', 'name', 'name', false, true, allowIdReferenceSyntax, this._contentsAllowedVersionsV2);
        if (valueCount > 300) {
          parsingErrors.push(new ParsingError(
      ...
      case 'dtmi:dtdl:property:extends;2':
        valueCount = InterfaceInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._extendsValueConstraints, aggregateContext, parsingErrors, propValue, this.id, this.id, 'extends', undefined, undefined, true, true, allowIdReferenceSyntax, this._extendsAllowedVersionsV2);
        if (valueCount > 2) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:propertyCountAboveMax',
            {
      ...
      case 'dtmi:dtdl:property:schemas;2':
        ComplexSchemaInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._schemasValueConstraints, aggregateContext, parsingErrors, propValue, this.id, this.id, 'schemas', undefined, undefined, true, true, allowIdReferenceSyntax, this._schemasAllowedVersionsV2);
        continue;
      }
  ...
  parsePropertiesV3(model: Model, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], object: {[index: string]: any}, definedIn: string|undefined, allowIdReferenceSyntax: boolean): void {
    ...
    for (const propKey in object) {
      ...
      case 'dtmi:dtdl:property:contents;3':
        ContentInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._contentsValueConstraints, aggregateContext, parsingErrors, propValue, this.id, this.id, 'contents', 'name', 'name', false, true, allowIdReferenceSyntax, this._contentsAllowedVersionsV3);
        continue;
      case 'description':
      ...
      case 'dtmi:dtdl:property:extends;3':
        InterfaceInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._extendsValueConstraints, aggregateContext, parsingErrors, propValue, this.id, this.id, 'extends', undefined, undefined, true, true, allowIdReferenceSyntax, this._extendsAllowedVersionsV3);
        continue;
      case 'schemas':
      case 'dtmi:dtdl:property:schemas;3':
        ComplexSchemaInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._schemasValueConstraints, aggregateContext, parsingErrors, propValue, this.id, this.id, 'schemas', undefined, undefined, true, true, allowIdReferenceSyntax, this._schemasAllowedVersionsV3);
        continue;
      }
...
**/
  ...
  applyTransformationsV2(model: Model, parsingErrors: ParsingError[]) {
    ...
    if (sources !== undefined) {
      sources.forEach((dtmi) => {
        (model.dict[dtmi] as InterfaceInfoImpl).importContents(new InDTMI(this.id), `'extends'`, this.contents || {}, parsingErrors);
      });
  ...
  checkRestrictionsV3(parsingErrors: ParsingError[]) {
    ...
    if (numExtendsNarrowValues > 1024) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:excessiveCount',
        {
    ...
    const numContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrowValues: number = this.getCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(parsingErrors);
...
**/
  checkDepthOfElementSchemaOrSchema(depth: number, depthLimit: number, tooDeepElementId: Reference<InDTMI>, parsingErrors: ParsingError[]): boolean {
    for (const item of Object.values(this.contents || {})) {
      if (!(item as ContentInfoImpl).checkDepthOfElementSchemaOrSchema(depth, depthLimit, tooDeepElementId, parsingErrors)) {
    ...
    for (const item of this.extends || []) {
      if (!(item as InterfaceInfoImpl).checkDepthOfElementSchemaOrSchema(depth, depthLimit, tooDeepElementId, parsingErrors)) {
        if (tooDeepElementId.ref?.value === this.id) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:recursiveStructure',
            {
    ...
    for (const item of this.schemas || []) {
      if (!(item as ComplexSchemaInfoImpl).checkDepthOfElementSchemaOrSchema(depth, depthLimit, tooDeepElementId, parsingErrors)) {
        if (tooDeepElementId.ref?.value === this.id) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:recursiveStructure',
            {
  ...
  tryGetDescendantSchemaOrContentsComponentNarrow(elementId: Reference<InDTMI>): boolean {
    ...
    for (const item of Object.values(this.contents || {})) {
      if ((item as ContentInfoImpl).entityKind === EntityKind.COMPONENT) {
  ...
  checkDescendantEnumValueDataType(ancestorId: InDTMI, datatype: string, parsingErrors: ParsingError[]): void {
    ...
    for (const item of Object.values(this.contents || {})) {
      (item as ContentInfoImpl).checkDescendantEnumValueDataType(ancestorId, datatype, parsingErrors);
    }

    for (const item of this.extends || []) {
      (item as InterfaceInfoImpl).checkDescendantEnumValueDataType(ancestorId, datatype, parsingErrors);
    }

    for (const item of this.schemas || []) {
      (item as ComplexSchemaInfoImpl).checkDescendantEnumValueDataType(ancestorId, datatype, parsingErrors);
    }
  }
  ...
  getTransitiveExtendsNarrow(depth: number, depthLimit: number, tooDeepElementId: Reference<InDTMI>, parsingErrors: ParsingError[]): Set<string> | undefined {
    ...
    for (const item of this.extends || []) {
      const others: Set<string> | undefined = (item as InterfaceInfoImpl).getTransitiveExtendsNarrow(depth + 1, depthLimit, tooDeepElementId, parsingErrors);
      if (others !== undefined) {
...
**/
  importContents(ancestorId: InDTMI, importPropertyName: string, contents: {[value: string]: ContentInfo}, parsingErrors: ParsingError[]): void {
    const currentObject = this._originalContents || this.contents || {};
    for (const [key, value] of Object.entries(currentObject)) {
      if (Object.prototype.hasOwnProperty.call(contents, key)) {
        parsingErrors.push(new ParsingError(
          'dtmi:dtdl:parsingError:nonUniqueImportedPropertyValue',
          {
  ...
  getCountOfExtendsNarrow(parsingErrors: ParsingError[]): number {
    ...
    for (const item of this.extends || []) {
      this._countOfExtendsNarrowValue += (item as InterfaceInfoImpl).getCountOfExtendsNarrow(parsingErrors) + 1;
    }
  ...
  getCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(parsingErrors: ParsingError[]): number {
    ...
    for (const item of Object.values(this.contents || {})) {
      this._countOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrowValue += (item as ContentInfoImpl).getCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(parsingErrors) + 1;
    }
