...
export class SupplementalTypeCollection {
    ...
    // Warning: (ae-forgotten-export) The symbol "SupplementalTypeInfoImpl" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
    supplementalTypes: Map<string, SupplementalTypeInfoImpl>;
}
