...
export class CommandResponseInfoImpl implements CommandResponseInfo, TypeChecker {
  ...
  doesHaveType(typeId: string): boolean {
    return (
      CommandResponseInfoImpl._versionlessTypes.has(new InDTMI(typeId).versionless) ||
  ...
  static parseObject(
    ...
    switch (childAggregateContext.dtdlVersion) {
      case 3: {
        (elementInfo as CommandResponseInfoImpl)?.parsePropertiesV3(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
    ...
    for (const supplementalTypeId of supplementalTypeIds) {
      ...
      if (elementInfo.ref !== undefined && elementInfo.ref.entityKind !== undefined) {
        if (
          ...
          (elementInfo.ref as CommandResponseInfoImpl).addType(
            supplementalTypeId,
  ...
  static tryParseTypeStringV3(
    ...
    elementInfo: Reference<CommandResponseInfo>,
