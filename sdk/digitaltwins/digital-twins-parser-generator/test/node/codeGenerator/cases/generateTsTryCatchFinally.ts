...
const tsTryCatchFinallyTestCases: Array<(outputDir: string) => testCaseType> = [
  function createSimpleClass(outputDir: string): testCaseType {
    ...
    return {name: 'try catch finally block', codeGenerator: tsLibrary, fileName: 'tsTryCatchFinally.ts'};
  },

];

export const tsTryCatchFinallyCase = {unitUnderTest: 'TsTryCatchFinally', testCases: tsTryCatchFinallyTestCases};
