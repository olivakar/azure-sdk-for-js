...
export class EnumValueInfoImpl implements EnumValueInfo, TypeChecker {
  ...
  doesHaveType(typeId: string): boolean {
    return (
      EnumValueInfoImpl._versionlessTypes.has(new InDTMI(typeId).versionless) ||
  ...
  static parseObject(
    ...
    switch (childAggregateContext.dtdlVersion) {
      case 2: {
        (elementInfo as EnumValueInfoImpl)?.parsePropertiesV2(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
      ...
      case 3: {
        (elementInfo as EnumValueInfoImpl)?.parsePropertiesV3(
          model,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
  ...
  static tryParseTypeStringV2(
    ...
    elementInfo: Reference<EnumValueInfo>,
    ...
    for (const propKey in object) {
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:enumValue;2":
          ...
          const enumValueValueAndType = ValueParser.parseSingularLiteralToken(
            this.id,
            "enumValue",
            propValue,
            parsingErrors
  ...
  checkDescendantEnumValueDataType(
    ...
    if (this._checkedDescendantEnumValueDatatype !== datatype) {
      ...
      if (typeof this.enumValue !== datatype) {
        parsingErrors.push(
          createParsingError("dtmi:dtdl:parsingError:nonConformantDatatype", {
