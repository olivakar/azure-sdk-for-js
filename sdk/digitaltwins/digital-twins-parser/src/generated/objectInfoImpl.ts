...
import {ObjectKinds} from './internal';
...
export class ObjectInfoImpl implements ObjectInfo, TypeChecker {
  ...
  protected static _concreteKinds: {[x: number]: ObjectKinds[]};
  ...
  constructor(dtdlVersion: number, id: string, childOf: string|undefined, definedIn: string|undefined, entityKind: ObjectKinds) {
