...
import {InDTMI, ParsingError, ParsingException} from '../parser';
/**
...
export class IdValidator {
  ...
  static GLOBAL_ID_PATTERN_3 = new RegExp('^dtmi:[A-Za-z](?:[A-Za-z0-9_]*[A-Za-z0-9])?(?::[A-Za-z](?:[A-Za-z0-9_]*[A-Za-z0-9])?)*(?:;[1-9][0-9]{0,8}(?:\\.[1-9][0-9]{0,5})?)?(?:#(?:[A-Za-z](?:[A-Za-z0-9_]*[A-Za-z0-9])?)?)?$');
  static GLOBAL_ID_PATTERN_2 = new RegExp('^dtmi:[A-Za-z](?:[A-Za-z0-9_]*[A-Za-z0-9])?(?::[A-Za-z](?:[A-Za-z0-9_]*[A-Za-z0-9])?)*;[1-9][0-9]{0,8}$');
  ...
  public static parseIdProperty(obj: any, parentId: string|undefined, propName: string|undefined, dtmiSeg: string|undefined, idRequired: boolean, parsingErrors: ParsingError[], dtdlVersion:number): string {
    let idString = '';
    const idToken = obj['@id'];
    if (idToken) {
      if (typeof idToken !== 'string') {
        parsingErrors.push(new ParsingError(
          'dtmi:dtdl:parsingError:invalidId',
          {
      ...
      if (length && idToken.length > length) {
        parsingErrors.push(new ParsingError(
          'dtmi:dtdl:parsingError:idTooLong',
          {
      ...
      if (idRequired) {
        parsingErrors.push(new ParsingError(
          'dtmi:dtdl:parsingError:missingRequiredId',
          {
      ...
      if (parentId !== undefined) {
        ...
        if (delimeterPos < 0) {
          ...
          idString = parentId.substring(0, delimeterPos) + ':_' + propName + secondSeg + parentId.substring(delimeterPos);
        }
      }
    }
    return idString;
