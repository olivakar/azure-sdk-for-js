...
export class ValueParser {
  public static parseSingularStringToken(elementId: string, propertyName: string, token: any, maxLength: number | undefined, pattern: RegExp | undefined, parsingErrors: ParsingError[]): string | undefined {
    let value: string | undefined;

    if (token === undefined) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:stringNoValue',
        {
      ...
      if (token.length == 0) {
        ...
        parsingErrors.push(new ParsingError(
          'dtmi:dtdl:parsingError:stringMultipleValues',
          {
    ...
    if (value !== undefined && maxLength !== undefined && value.length > maxLength) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:stringTooLong',
        {
    ...
    if (value !== undefined && pattern !== undefined && !pattern.test(value)) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:stringInvalid',
        {
  ...
  public static parseSingularIntegerToken(elementId: string, propertyName: string, token: any, minInclusive: number | undefined, maxInclusive: number | undefined, parsingErrors: ParsingError[]): number {
    let value: number | undefined;

    if (token === undefined) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:integerNoValue',
        {
          cause: `{primaryId:p} property '${propertyName}' has no value.`,
    ...
    if (value !== undefined && minInclusive !== undefined && maxInclusive !== undefined && minInclusive == maxInclusive && value != minInclusive) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:valueNotExact',
        {
  ...
  public static parseSingularBooleanToken(elementId: string, propertyName: string, token: any, parsingErrors: ParsingError[]): boolean {
    if (token === undefined) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:booleanNoValue',
        {
          cause: `{primaryId:p} property '${propertyName}' has no value.`,
          action: `Provide an integer value for '${propertyName}'.`,
          primaryId: elementId,
  ...
  public static parseLangStringToken(elementId: string, propertyName: string, token: any, defaultLang: string, maxLength: number | undefined, pattern: RegExp | undefined, parsingErrors: ParsingError[]): { [index: string]: string } {
    let dict: { [index: string]: string };

    if (token === undefined) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:langStringNoValue',
        {
          cause: `{primaryId:p} property '${propertyName}' has no value.`,
      ...
      dict = ValueParser._getDictionaryFromLanguageTaggedStringArray(elementId, propertyName, token, parsingErrors);
    } else if (typeof token === 'object') {
      dict = ValueParser._getDictionaryFromLanguageMap(elementId, propertyName, token, parsingErrors);
    } else {
      parsingErrors.push(new ParsingError(
  ...
  public static parseSingularLiteralToken(elementId: string, propertyName: string, token: any, parsingErrors: ParsingError[]): { value: any, typeFragment: string } {
    let value: any;
    let typeFragment: string = '';

    if (token === undefined) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:literalNoValue',
        {
          cause: `{primaryId:p} property '${propertyName}' has no value.`,
      ...
      if (token.length == 0) {
        ...
        parsingErrors.push(new ParsingError(
          'dtmi:dtdl:parsingError:literalNotValid',
          {
            cause: `{primaryId:p} property '${propertyName}' has value ${JSON.stringify(token[0])}, which is not a JSON string, integer, or boolean.`,
      ...
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:literalNotValid',
        {
          cause: `{primaryId:p} property '${propertyName}' has value ${JSON.stringify(token)}, which is not a JSON string, integer, or boolean.`,
          action: `Change the value of '${propertyName}' to a JSON string, integer, or boolean.`,
          primaryId: elementId,
          property: propertyName,
          value: JSON.stringify(token),
  ...
  public static parseSingularIdentifierToken(elementId: string, propertyName: string, token: any, maxLength: number | undefined, pattern: RegExp | undefined, parsingErrors: ParsingError[]): string | undefined {
    let value: string;

    if (token === undefined) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:identifierNoValue',
        {
          cause: `{primaryId:p} property '${propertyName}' has no value.`,
    ...
    if (Array.isArray(token)) {
      ...
      if (typeof token[0] !== 'string') {
        parsingErrors.push(new ParsingError(
          'dtmi:dtdl:parsingError:identifierNotString',
          {
            cause: `{primaryId:p} property '${propertyName}' has value ${JSON.stringify(token[0])}, which is not a JSON string.`,
      ...
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:identifierNotString',
        {
          cause: `{primaryId:p} property '${propertyName}' has value ${JSON.stringify(token)}, which is not a JSON string.`,
          action: `Change the value of '${propertyName}' to a JSON string that is a valid DTMI.`,
          primaryId: elementId,
          property: propertyName,
          value: JSON.stringify(token),
    ...
    if (maxLength !== undefined && value.length > maxLength) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:identifierTooLong',
        {
          cause: `{primaryId:p} property '${propertyName}' has value '${value}', which is too long -- length limit is ${maxLength}.`,
          action: `Select a shorter value for '${propertyName}' or trim current value to fewer than ${maxLength} characters.`,
          primaryId: elementId,
    ...
    if (pattern !== undefined && !pattern.test(value)) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:identifierInvalid',
        {
  ...
  private static _getStringFromToken(elementId: string, propertyName: string, token: any, parsingErrors: ParsingError[]): string | undefined {
    if (typeof token === 'object') {
      if (!Object.prototype.hasOwnProperty.call(token, '@value')) {
        parsingErrors.push(new ParsingError(
          'dtmi:dtdl:parsingError:stringObjectNoValue',
          {
      ...
      if (typeof valToken !== 'string') {
        parsingErrors.push(new ParsingError(
          'dtmi:dtdl:parsingError:stringValueNotString',
          {
            cause: `{primaryId:p} property '${propertyName}' has value that is a JSON object whose '@value' is ${JSON.stringify(valToken)}, which is not a JSON string.`,
    ...
    if (typeof token !== 'string') {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:stringNotString',
        {
          cause: `{primaryId:p} property '${propertyName}' has value ${JSON.stringify(token)}, which is not a JSON string.`,
  ...
  private static _getIntegerFromToken(elementId: string, propertyName: string, token: any, parsingErrors: ParsingError[]): number | undefined {
    if (typeof token === 'object') {
      if (!Object.prototype.hasOwnProperty.call(token, '@value')) {
        parsingErrors.push(new ParsingError(
          'dtmi:dtdl:parsingError:integerObjectNoValue',
          {
            cause: `{primaryId:p} property '${propertyName}' has value that is a JSON object with no '@value' property.`,
      ...
      if (typeof valToken !== 'number' || !Number.isInteger(valToken)) {
        parsingErrors.push(new ParsingError(
          ...
          {
            cause: `{primaryId:p} property '${propertyName}' has value that is a JSON object whose '@value' is ${JSON.stringify(valToken)}, which is not a JSON integer.`,
    ...
    if (typeof token !== 'number' || !Number.isInteger(token)) {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:integerNotInteger',
        {
  ...
  private static _getBooleanFromToken(elementId: string, propertyName: string, token: any, parsingErrors: ParsingError[]): boolean {
    if (typeof token === 'object') {
      if (!Object.prototype.hasOwnProperty.call(token, '@value')) {
        parsingErrors.push(new ParsingError(
          'dtmi:dtdl:parsingError:booleanObjectNoValue',
          {
            cause: `{primaryId:p} property '${propertyName}' has value that is a JSON object with no '@value' property.`,
      ...
      if (typeof valToken !== 'boolean') {
        parsingErrors.push(new ParsingError(
          ...
          {
            cause: `{primaryId:p} property '${propertyName}' has value that is a JSON object whose '@value' is ${JSON.stringify(valToken)}, which is not a JSON boolean.`,
    ...
    if (typeof token !== 'boolean') {
      parsingErrors.push(new ParsingError(
        'dtmi:dtdl:parsingError:booleanNotBoolean',
        {
  ...
  private static _getDictionaryFromLanguageTaggedStringArray(elementId: string, propertyName: string, array: any[], parsingErrors: ParsingError[]): { [index: string]: string } {
      ...
      if (typeof element !== 'object') {
        ...
        if (!Object.prototype.hasOwnProperty.call(element, '@language')) {
          parsingErrors.push(new ParsingError(
            ...
            {
              cause: `{primaryId:p} property '${propertyName}' array has element '${JSON.stringify(element)}', which does not contain a '@language' property.`,
          ...
          if (typeof codeToken !== 'string') {
            parsingErrors.push(new ParsingError(
              ...
              {
                cause: `{primaryId:p} property '${propertyName}' array has element with language code '${JSON.stringify(codeToken)}', which is not a JSON string.`,
        ...
        if (!Object.prototype.hasOwnProperty.call(element, '@value')) {
          parsingErrors.push(new ParsingError(
            ...
            {
              cause: `{primaryId:p} property '${propertyName}' array has element '${JSON.stringify(element)}', which does not contain a '@value' property.`,
          ...
          if (typeof valueToken !== 'string') {
            parsingErrors.push(new ParsingError(
              ...
              {
                cause: `{primaryId:p} property '${propertyName}' array has element with '@value' value '${JSON.stringify(valueToken)}', which is not a JSON string.`,
  ...
  private static _getDictionaryFromLanguageMap(elementId: string, propertyName: string, obj: {[index: string]: any}, parsingErrors: ParsingError[]): {[index: string]: string} {
    const dict: { [index: string]: string } = {};

    for (const langCode in obj) { // eslint-disable-line guard-for-in
      let assignOk = true;
      ...
      if (typeof langValue !== 'string') {
        parsingErrors.push(new ParsingError(
          ...
          {
            cause: `{primaryId:p} property '${propertyName}' with language code '${langCode}' has value ${JSON.stringify(langValue)}, which is not a JSON string.`,
