...
export class CommandInfoImpl implements CommandInfo, TypeChecker {
  ...
  constructor(dtdlVersion: number, id: string, childOf: string|undefined, definedIn: string|undefined, entityKind: EntityKind = EntityKind.COMMAND) {
...
.add('dtmi:dtdl:class:NamedEntity');
  ...
  doesHaveType(typeId: string): boolean {
    return CommandInfoImpl._versionlessTypes.has(new InDTMI(typeId).versionless) ||
this.supplementalTypes.some((st) => (st as SupplementalTypeInfoImpl).doesHaveType(typeId))
  ...
  static parseObject(model: Model, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], valueConstraints: ValueConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], object: {[index: string]: any}, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, dtmiSeg: string|undefined, keyProp: string|undefined, idRequired: boolean, typeRequired: boolean, allowIdReferenceSyntax: boolean, allowedVersions: Set<number>): any {
    ...
    case 2: {
      (elementInfo as CommandInfoImpl)?.parsePropertiesV2(model, objectPropertyInfoList, elementPropertyConstraints, childAggregateContext, parsingErrors, object, definedIn, allowIdReferenceSyntax);
      break;
    }

    case 3: {
      (elementInfo as CommandInfoImpl)?.parsePropertiesV3(model, objectPropertyInfoList, elementPropertyConstraints, childAggregateContext, parsingErrors, object, definedIn, allowIdReferenceSyntax);
      break;
    }
    }
  ...
  static parseTypeArray(tokenArr: any[], elementId: string, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, aggregateContext: AggregateContext, parsingErrors: ParsingError[]): CommandInfo|undefined {
  ...
  static tryParseTypeStringV2(typestring: string, elementId: string, parentId: string|undefined, definedIn: string|undefined, propName: string|undefined, materialKinds: EntityKind[], supplementalTypeIds: string[], elementInfo: Reference<CommandInfo>, undefinedTypes: string[], aggregateContext: AggregateContext, parsingErrors: ParsingError[]): boolean {
    switch (typestring) {
    case 'Command':
  ...
  parsePropertiesV2(model: Model, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], object: {[index: string]: any}, definedIn: string|undefined, allowIdReferenceSyntax: boolean): void {
    ...
    for (const propKey in object) {
      ...
      case 'dtmi:dtdl:property:commandType;2':
        valueCount = CommandTypeInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._commandTypeValueConstraints, aggregateContext, parsingErrors, propValue, this.id, definedIn ?? this.id, 'commandType', undefined, undefined, true, true, allowIdReferenceSyntax, this._commandTypeAllowedVersionsV2);
        if (valueCount > 1) {
          parsingErrors.push(new ParsingError(
      ...
      case 'dtmi:dtdl:property:request;2':
        valueCount = CommandPayloadInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._requestValueConstraints, aggregateContext, parsingErrors, propValue, this.id, definedIn ?? this.id, 'request', undefined, undefined, false, false, allowIdReferenceSyntax, this._requestAllowedVersionsV2);
        if (valueCount > 1) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:propertyCountAboveMax',
            {
      ...
      case 'dtmi:dtdl:property:response;2':
        valueCount = CommandPayloadInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._responseValueConstraints, aggregateContext, parsingErrors, propValue, this.id, definedIn ?? this.id, 'response', undefined, undefined, false, false, allowIdReferenceSyntax, this._responseAllowedVersionsV2);
        if (valueCount > 1) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:propertyCountAboveMax',
            {
  ...
  parsePropertiesV3(model: Model, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], object: {[index: string]: any}, definedIn: string|undefined, allowIdReferenceSyntax: boolean): void {
    ...
    for (const propKey in object) {
      ...
      case 'dtmi:dtdl:property:commandType;3':
        valueCount = CommandTypeInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._commandTypeValueConstraints, aggregateContext, parsingErrors, propValue, this.id, definedIn ?? this.id, 'commandType', undefined, undefined, true, true, allowIdReferenceSyntax, this._commandTypeAllowedVersionsV3);
        if (valueCount > 1) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:propertyCountAboveMax',
            {
      ...
      case 'dtmi:dtdl:property:request;3':
        valueCount = CommandRequestInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._requestValueConstraints, aggregateContext, parsingErrors, propValue, this.id, definedIn ?? this.id, 'request', undefined, undefined, false, false, allowIdReferenceSyntax, this._requestAllowedVersionsV3);
        if (valueCount > 1) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:propertyCountAboveMax',
            {
      ...
      case 'dtmi:dtdl:property:response;3':
        valueCount = CommandResponseInfoImpl.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, this._responseValueConstraints, aggregateContext, parsingErrors, propValue, this.id, definedIn ?? this.id, 'response', undefined, undefined, false, false, allowIdReferenceSyntax, this._responseAllowedVersionsV3);
        if (valueCount > 1) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:propertyCountAboveMax',
            {
  ...
  checkRestrictionsV2(parsingErrors: ParsingError[]) {
    if (this._commandTypeInstanceProperties !== undefined) {
      for (const instanceProp of this._commandTypeInstanceProperties) {
        if (!(this.commandType as CommandTypeInfoImpl)?.validateInstanceElement(this.supplementalProperties[instanceProp])) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:nonConformantPropertyValue',
            {
              cause: '{{primaryId:n}} property \'{{property}}\' does not conform to the type specified by property \'commandType\' ',
              action: 'Change the value of property \'{{property}}\' so that it conforms to property  \'commandType\'',
              primaryId: this.id,
    ...
    if (this._requestInstanceProperties !== undefined) {
      for (const instanceProp of this._requestInstanceProperties) {
        if (!(this.request as CommandPayloadInfoImpl)?.validateInstanceElement(this.supplementalProperties[instanceProp])) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:nonConformantPropertyValue',
            {
              cause: '{{primaryId:n}} property \'{{property}}\' does not conform to the type specified by property \'request\' ',
              action: 'Change the value of property \'{{property}}\' so that it conforms to property  \'request\'',
              primaryId: this.id,
              property: instanceProp,
            }));
        }
    ...
    if (this._responseInstanceProperties !== undefined) {
      for (const instanceProp of this._responseInstanceProperties) {
        if (!(this.response as CommandPayloadInfoImpl)?.validateInstanceElement(this.supplementalProperties[instanceProp])) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:nonConformantPropertyValue',
            {
              cause: '{{primaryId:n}} property \'{{property}}\' does not conform to the type specified by property \'response\' ',
              action: 'Change the value of property \'{{property}}\' so that it conforms to property  \'response\'',
              primaryId: this.id,
              property: instanceProp,
            }));
        }
...
**/
  checkDepthOfElementSchemaOrSchema(depth: number, depthLimit: number, tooDeepElementId: Reference<InDTMI>, parsingErrors: ParsingError[]): boolean {
    if (this.commandType !== undefined) {
      if (!(this.commandType as CommandTypeInfoImpl).checkDepthOfElementSchemaOrSchema(depth, depthLimit, tooDeepElementId, parsingErrors)) {
    ...
    if (this.request !== undefined) {
      if (!(this.request as CommandPayloadInfoImpl).checkDepthOfElementSchemaOrSchema(depth, depthLimit, tooDeepElementId, parsingErrors)) {
        if (tooDeepElementId.ref?.value === this.id) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:recursiveStructure',
            {
    ...
    if (this.response !== undefined) {
      if (!(this.response as CommandPayloadInfoImpl).checkDepthOfElementSchemaOrSchema(depth, depthLimit, tooDeepElementId, parsingErrors)) {
        if (tooDeepElementId.ref?.value === this.id) {
          parsingErrors.push(new ParsingError(
            'dtmi:dtdl:parsingError:recursiveStructure',
            {
  ...
  checkDescendantEnumValueDataType(ancestorId: InDTMI, datatype: string, parsingErrors: ParsingError[]): void {
    ...
    if (this.commandType !== undefined) {
      (this.commandType as CommandTypeInfoImpl).checkDescendantEnumValueDataType(ancestorId, datatype, parsingErrors);
    }

    if (this.request !== undefined) {
      (this.request as CommandPayloadInfoImpl).checkDescendantEnumValueDataType(ancestorId, datatype, parsingErrors);
    }

    if (this.response !== undefined) {
      (this.response as CommandPayloadInfoImpl).checkDescendantEnumValueDataType(ancestorId, datatype, parsingErrors);
    }
  }
  ...
  tryGetDescendantSchemaArray(elementId: Reference<InDTMI>): boolean {
    ...
    if (this.commandType !== undefined) {
      if ((this.commandType as CommandTypeInfoImpl).tryGetDescendantSchemaArray(elementId)) {
    ...
    if (this.request !== undefined) {
      if ((this.request as CommandPayloadInfoImpl).tryGetDescendantSchemaArray(elementId)) {
        this._idOfDescendantSchemaArray = elementId.ref;
        return true;
      }
    }
    ...
    if (this.response !== undefined) {
      if ((this.response as CommandPayloadInfoImpl).tryGetDescendantSchemaArray(elementId)) {
        this._idOfDescendantSchemaArray = elementId.ref;
        return true;
      }
    }
  ...
  getCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(parsingErrors: ParsingError[]): number {
    ...
    if (this.request !== undefined) {
      this._countOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrowValue += (this.request as CommandPayloadInfoImpl).getCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(parsingErrors) + 1;
    }

    if (this.response !== undefined) {
      this._countOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrowValue += (this.response as CommandPayloadInfoImpl).getCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(parsingErrors) + 1;
    }
